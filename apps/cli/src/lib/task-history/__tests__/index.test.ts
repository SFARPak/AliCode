import { readTaskSessionsFromStoragePath } from "@ali-code/core/cli"
...
vi.mock("@ali-code/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@ali-code/core/cli")>()
	return {
		...actual,
