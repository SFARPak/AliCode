...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@ali-code/types"
...
/**
 * ExtensionClient is the main interface for interacting with the AliCode extension.
 *
 * Basic usage:
 * ```typescript
