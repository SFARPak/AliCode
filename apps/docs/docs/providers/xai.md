---
description: Configure xAI's Grok models in AliCode. Access Grok-4, Grok-3, Grok-2, and vision models with large context windows, reasoning capabilities, and prompt caching.
keywords:
    - xAI
    - Grok
    - AliCode
...
3.  **Create a Key:** Click to create a new API key. Give your key a descriptive name (e.g., "AliCode").
...
AliCode supports all Grok models available through xAI's API.
