---
description: Access Google Gemini and Anthropic Claude models through GCP Vertex AI in AliCode. Configure authentication and start using enterprise AI.
keywords:
    - Vertex AI
    - GCP
    - Google Cloud
...
# Using GCP Vertex AI With AliCode

AliCode supports accessing models through Google Cloud Platform's Vertex AI, a managed machine learning platform that provides access to various foundation models, including Anthropic's Claude family.
...
- **Application Default Credentials (ADC):** AliCode uses Application Default Credentials to authenticate with Vertex AI. The easiest way to set this up is to:
...
AliCode supports all models available through Google Cloud Vertex AI, including Anthropic Claude, Google Gemini, and MAAS (Model as a Service) offerings.
...
3.  **Configure Authentication:**
    ...
    AliCode uses the following authentication priority:
    ...
    **Option 1 - Using ADC (Simplest):**
    ...
    - No further configuration needed in AliCode
