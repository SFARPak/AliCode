...
description: Configure DeepSeek's chat and reasoning models in AliCode. Access deepseek-chat and deepseek-reasoner for coding and complex reasoning tasks.
keywords:
    - deepseek
    - deepseek chat
    - deepseek reasoner
...
# Using DeepSeek With AliCode

AliCode supports accessing models through the DeepSeek API, including `deepseek-chat` and `deepseek-reasoner`.
...
3.  **Create a Key:** Click "Create new API key". Give your key a descriptive name (e.g., "AliCode").
...
AliCode supports all models available through the DeepSeek API.
