...
description: Configure MiniMax’s OpenAI‑compatible API in AliCode. Choose the right region base URL and start chatting.
keywords:
    - minimax
    - mini max
    - openai compatible
...
1. Open AliCode Settings (gear icon).
