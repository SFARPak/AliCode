---
description: AliCode 3.13.1 adds Gemini 2.5 Flash thinking mode support, improves auto-approval toggle UI, and fixes Windows file path issues.
keywords:
    - roo code
    - v3.13.1
    - release notes
...
# AliCode 3.13.1 Release Notes (2025-04-18)
