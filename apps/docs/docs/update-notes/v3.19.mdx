---
description: AliCode 3.19 focuses on UI improvements with intelligent context condensing enabled by default, enhanced file protection, and experimental multi-file reading.
keywords:
  - AliCode 3.19
  - release notes
  - context condensing
...
# AliCode 3.19 Release Notes (2025-06-09)
...
Thank you to all our contributors for making AliCode better with each release!