...
# AliCode 3.19.0 Release Notes (2025-05-30)
...
*   **Enhanced Sidebar Compatibility**: Menu functionality now remains stable when moving Ali between primary and secondary sidebars (thanks chrarnoldus!)

---

## Bug Fixes

*   **Directory Mention Protection**: Fixed [`@directory`](/basic-usage/context-mentions) not respecting [`.aliignore`](/features/rooignore) files (thanks xyOz-dev!)
