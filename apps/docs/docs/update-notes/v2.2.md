---
description: AliCode 2.2 introduces MCP support for custom tools, API configuration profiles, enhanced diff editing, and numerous quality-of-life improvements.
keywords:
    - roo code
    - v2.2
    - mcp support
...
# AliCode 2.2 Release Notes (2025-02-27)
...
- **Model Context Protocol (MCP) Support (v2.2.0):**
    - Added support for MCP, enabling AliCode to use custom tools like web search or GitHub tools.
    - Added an MCP server management tab.
    - Enabled AliCode to dynamically create new MCP servers based on user requests.
...
- **Ali Cline Runs in All VSCode-Compatible Editors (v2.1.6).**
- **Ali Cline Side-by-Side with Cline (v2.1.4).**
