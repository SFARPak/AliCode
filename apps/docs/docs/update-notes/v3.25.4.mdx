---
description: AliCode 3.25.4 adds Doubao and SambaNova providers, introduces context-aware prompt enhancement, and improves tool functionality.
keywords:
  - roo code 3.25.4
  - doubao provider
  - sambanova provider
...
# AliCode 3.25.4 Release Notes (2025-07-31)
...
- **Easy Configuration**: Simple setup through AliCode's provider settings with internationalized prompts
...
SambaNova brings enterprise-grade AI infrastructure to AliCode, offering powerful alternatives for your development workflows.
