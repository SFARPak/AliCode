---
description: AliCode 3.11.10 fixes nested .ali/rules directories, OpenAI provider caching, and improves command output handling and translations.
keywords:
    - roo code
    - v3.11.10
    - release notes
...
# AliCode 3.11.10 Release Notes (2025-04-08)
...
- Fixed bug where nested `.ali/rules` directories are not respected properly (thanks @taisukeoe!).
