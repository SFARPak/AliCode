---
description: AliCode 3.50.0 adds Gemini 3.1 Pro support with updated default model and overhauls the CLI stdin interface with a structured NDJSON protocol and new list subcommands.
keywords:
  - roo code 3.50.0
  - gemini 3.1 pro
  - ndjson stdin
...
# AliCode 3.50.0 Release Notes (2026-02-19)
