---
description: This release introduces the Sonic model to AliCode users with announcements to help discover the new model.
keywords:
  - roo code v3.25.20
  - sonic model
  - model announcements
...
# AliCode v3.25.20 Release Notes (2025-08-20)

This release introduces the Sonic model to AliCode users with announcements to help discover the new model.
