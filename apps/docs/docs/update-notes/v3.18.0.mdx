---
description: This release introduces comprehensive context condensing improvements, YAML support for custom modes, new AI model integrations, and numerous quality-of-life improvements and bug fixes.
---

# AliCode 3.18.0 Release Notes (2025-05-21)
...
Custom mode configuration is now significantly improved with **YAML support** for both global and project-level (`.alimodes`) definitions. YAML is the new default, offering superior readability with cleaner syntax, support for comments (`#`), and easier multi-line string management. While JSON remains supported for backward compatibility, YAML streamlines mode creation, sharing, and version control.
...
To enhance API cost management, you can now set a **Max Requests** limit for auto-approved actions. This prevents AliCode from making an excessive number of consecutive API calls without your re-approval.

<img src="/img/v3.18.0/v3.18.0.png" alt="Setting the Max Requests limit for auto-approved actions in AliCode settings." width="600" />
