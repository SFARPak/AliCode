---
description: This release cycle introduces opt-in telemetry, significant terminal architecture improvements, a multi-diff editing strategy, .aliignore support, and a redesigned settings page, alongside numerous provider updates and bug fixes.
---

# AliCode 3.8 Release Notes (2025-03-13)

This release cycle introduces opt-in telemetry, significant terminal architecture improvements, a multi-diff editing strategy, `.aliignore` support, and a redesigned settings page, alongside numerous provider updates and bug fixes.

---

## Key Features & Enhancements

- **Opt-in Telemetry:** Added opt-in telemetry to help improve AliCode faster. (thanks Cline!)
...
- **`.aliignore` Support:** Added support for a `.aliignore` file to prevent AliCode from reading/writing specified files, with an option to exclude them from search/lists. (thanks Cline!)
...
- **Simultaneous Ali Instances:** Support for running AliCode in multiple editor windows simultaneously. (thanks @samhvw8!)
