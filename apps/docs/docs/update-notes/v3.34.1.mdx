---
description: This patch release lets eval jobs run on AliCode Cloud models, clarifies image generation prompts, cleans up todo list updates, and fixes duplicate cloud message sync.
keywords:
  - roo code 3.34.1
...
# AliCode 3.34.1 Release Notes (2025-11-23)

This patch release lets evaluation jobs run on AliCode Cloud models, makes image generation prompts easier to read, cleans up todo list updates, and prevents duplicate cloud-synced messages.
