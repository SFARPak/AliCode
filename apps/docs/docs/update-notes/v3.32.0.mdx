---
description: AliCode 3.32.0 adds GPT-5.1 models, enables OpenAI Responses prompt caching, fixes the share button, and improves release-note traceability.
keywords:
  - roo code 3.32.0
  - gpt-5.1
...
# AliCode 3.32.0 Release Notes (2025-11-14)
...
<img src="/img/v3.32.0/v3.32.0.png" alt="AliCode v3.32.0 Release" width="600" />

## Features & Improvements

* **GPT-5.1 in AliCode** ([#9252](https://github.com/RooCodeInc/Roo-Code/pull/9252), [#9258](https://github.com/RooCodeInc/Roo-Code/pull/9258), [#9261](https://github.com/RooCodeInc/Roo-Code/pull/9261), [#9259](https://github.com/RooCodeInc/Roo-Code/pull/9259)): Adds all new GPT-5.1 models to the OpenAI Native provider with extended 24‑hour prompt caching support, all new GPT-5.1 models and overall support for 51 throughout other supported providers.
