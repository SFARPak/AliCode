...
# AliCode 3.25.11 Release Notes (2025-08-11)
...
* **`@ali-code/cloud` Linking**: Improved the developer workflow by allowing `@ali-code/cloud` to be directly linked from a local repository, with HMR support ([#6799](https://github.com/RooCodeInc/Roo-Code/pull/6799)).
