---
description: AliCode 2.1.14 fixes diff application bugs, adds unified diff prompts, and auto-rejects truncated outputs for more reliable diff editing.
keywords:
    - roo code 2.1.14
    - diff editing fixes
    - unified diff
