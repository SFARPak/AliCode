---
description: AliCode 3.3 brings VS Code code actions, mode switching, Debug mode, experimental checkpoints, @terminal mentions, enhanced Markdown editing, and extensive provider updates.
keywords:
    - roo code 3.3
    - code actions
    - debug mode
...
# AliCode 3.3 Release Notes (2025-02-27)
...
- **Project-Specific Custom Modes:** Support for project-specific custom modes in a `.alimodes` file.
...
- **New Task Tool:** Added a `new_task` tool that allows Ali to start new tasks with an initial message and mode.
