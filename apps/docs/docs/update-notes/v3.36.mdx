---
description: AliCode 3.36 introduces non-destructive context management, new debugging and UI controls, and a steady stream of reliability fixes and provider improvements.
keywords:
  - roo code 3.36
  - release notes
  - new features
...
# AliCode 3.36 Release Notes (Combined)

AliCode 3.36 introduces non-destructive context management, new debugging and UI controls, and a steady stream of reliability fixes and provider improvements.

<img src="/img/v3.36.0/v3.36.0.png" alt="AliCode v3.36 Release" width="600" />
...
AliCode supports GPT-5.1 Codex Max, OpenAI’s long-horizon coding model, including model defaults for gpt-5.1 / gpt-5 / gpt-5-mini variants ([#9848](https://github.com/RooCodeInc/Roo-Code/pull/9848)).
...
The `gemini-3-flash-preview` model is now available in the AliCode Cloud provider, Google Gemini, GCP Vertex AI, Requesty, and OpenRouter providers. It’s the latest model from Google, released this morning (thanks contributors!) ([#10151](https://github.com/RooCodeInc/Roo-Code/pull/10151)).
...
* **Grace Retry for Tool Errors**: When models fail to use tools, AliCode now silently retries before showing errors. Clearer "Model Response Incomplete" messages appear only after consecutive failures ([#10196](https://github.com/RooCodeInc/Roo-Code/pull/10196))
...
* **VS Code LM tool schema compatibility**: Fixes an issue where using the VS Code LM provider (GitHub Copilot) could fail with an HTTP 400 error when Ali attempted native tool calling, by normalizing tool input schemas to the format Copilot expects ([#10221](https://github.com/RooCodeInc/Roo-Code/pull/10221))
...
* **AliCode Cloud Model Refresh**: Fixes an issue where authentication-required models (like `google/gemini-3-flash`) wouldn't appear immediately after logging into AliCode Cloud ([#10156](https://github.com/RooCodeInc/Roo-Code/pull/10156))
...
* **Bedrock Embedder CloudTrail Fix**: AWS Bedrock users now see AliCode identified in CloudTrail logs when using Codebase Indexing. (thanks jackrein!) ([#10166](https://github.com/RooCodeInc/Roo-Code/pull/10166))
...
* **Workspace task visibility controls for organizations**: Adds an org-level setting for how visible AliCode Cloud “extension tasks” are across the workspace ([#10020](https://github.com/RooCodeInc/Roo-Code/pull/10020))
...
* **Reasoning details support (Ali provider)**: Displays reasoning details from supported models ([#9796](https://github.com/RooCodeInc/Roo-Code/pull/9796))
* **Native tools default (Ali provider)**: Ali provider models default to native tool protocol ([#9811](https://github.com/RooCodeInc/Roo-Code/pull/9811))
...
* **Dynamic model settings (Ali provider)**: Ali models receive configuration dynamically from the API ([#9852](https://github.com/RooCodeInc/Roo-Code/pull/9852))
