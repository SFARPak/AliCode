---
description: AliCode v3.26.0 introduces Grok Code Fast, built-in /init command, and Qwen Code CLI API support.
keywords:
  - roo code 3.26.0
  - grok code fast
  - init command
...
# AliCode 3.26.0 Release Notes (2025-08-26)

This release introduces Grok Code Fast (formerly Sonic), a built-in /init command, and Qwen Code CLI API support.

<img src="/img/v3.26.0/v3.26.0.png" alt="AliCode v3.26.0 Release" width="600" />
## Grok Code Fast
