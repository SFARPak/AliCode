---
description: AliCode 3.21 launches the Ali Marketplace, adds Gemini 2.5 models support, Claude Max subscription integration, and Excel file support.
keywords:
  - AliCode 3.21
  - release notes
  - Ali Marketplace
...
# AliCode 3.21 Release Notes

This release launches the Ali Marketplace, adds support for the latest Gemini 2.5 models, and introduces Excel file support along with numerous improvements and fixes.

## [Ali Marketplace Launch](/features/marketplace)

We're excited to announce the official launch of the [Ali Marketplace](/features/marketplace) ([#4788](https://github.com/RooCodeInc/Roo-Code/pull/4788)):

- **Discover Great MCPs and Modes**: Browse and install community-created Model Context Protocol servers and custom modes directly from within AliCode
...
The Ali Marketplace makes it easy to extend AliCode's functionality with powerful integrations created by our vibrant community.

## Use Your Claude Max Subscription with AliCode

You can now use your Claude Max subscription directly in AliCode through our new Claude Code provider (thanks Cline!) ([#4864](https://github.com/RooCodeInc/Roo-Code/pull/4864), [#5038](https://github.com/RooCodeInc/Roo-Code/pull/5038)):

- **Leverage Your Existing Subscription**: Connect your Claude Max plan to AliCode through the Claude CLI
...
- **Seamless Integration**: Works with all existing AliCode tools and features
...
* **Marketplace Branding**: Updated to show "Ali Marketplace" for consistent branding ([#4718](https://github.com/RooCodeInc/Roo-Code/pull/4718))
