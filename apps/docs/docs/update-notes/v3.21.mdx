---
description: AliCode 3.21 launches the Roo Marketplace, adds Gemini 2.5 models support, Claude Max subscription integration, and Excel file support.
keywords:
  - AliCode 3.21
  - release notes
  - Roo Marketplace
...
The Roo Marketplace makes it easy to extend AliCode's functionality with powerful integrations created by our vibrant community.
