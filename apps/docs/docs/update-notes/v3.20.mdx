---
description: AliCode 3.20 introduces the experimental Marketplace for extensions and modes, concurrent file edits and reads, and prompt history navigation.
keywords:
  - AliCode 3.20
  - release notes
  - marketplace
...
# AliCode 3.20 Release Notes (2025-06-12)
...
**To enable:** Open AliCode settings (gear icon) → Experimental Settings → Enable "Marketplace"
...
**To enable:** Open AliCode settings (gear icon) → Experimental Settings → Enable "Enable multi-file edits"
...
*   **Types**: Move marketplace types to `@ali-code/types` (thanks jr!) ([#4671](https://github.com/RooCodeInc/Roo-Code/pull/4671))
