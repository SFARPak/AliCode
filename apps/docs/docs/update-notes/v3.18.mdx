---
description: AliCode 3.18 introduces experimental codebase indexing, enhanced context condensing, YAML support for custom modes, and Gemini 2.5 Flash support.
keywords:
  - AliCode 3.18
  - release notes
  - codebase indexing
...
# AliCode 3.18 Release Notes (2025-05-21)
