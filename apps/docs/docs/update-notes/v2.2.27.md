---
description: AliCode 2.2.27 adds current time to system prompts and enhances browser screenshot quality for improved functionality.
keywords:
    - roo code
    - v2.2.27
    - release notes
