---
description: AliCode 3.16.5 reverts provider profile management changes to fix a bug with defaults, ensuring stable API configuration.
keywords:
    - roo code
    - v3.16.5
    - release notes
...
# AliCode 3.16.5 Release Notes (2025-05-10)
