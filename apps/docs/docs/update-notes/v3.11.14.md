---
description: AliCode 3.11.14 adds support for symbolic links in rules folders and enforces full file reading settings for better reliability.
keywords:
    - roo code
    - v3.11.14
    - release notes
...
# AliCode 3.11.14 Release Notes (2025-04-11)
