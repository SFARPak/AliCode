---
description: AliCode 3.16.2 provides clearer XML tool formatting instructions and improved error handling for streaming, enhancing reliability.
keywords:
    - roo code
    - v3.16.2
    - release notes
...
# AliCode 3.16.2 Release Notes (2025-05-07)
