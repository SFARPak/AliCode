...
# AliCode 3.25.12 Release Notes (2025-08-12)
...
```json
{
  "alicode.apiRequestTimeout": 1200  // 20 minutes for very large models
}
```
...
* **File Indexing**: JSON files now properly respect .aliignore settings during indexing ([#6691](https://github.com/RooCodeInc/Roo-Code/pull/6691))
