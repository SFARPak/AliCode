---
description: AliCode 3.17.1 fixes command display during approval and corrects token calculation on OpenRouter for accurate cost tracking.
keywords:
    - roo code
    - v3.17.1
    - release notes
...
# AliCode 3.17.1 Release Notes (2025-05-15)
