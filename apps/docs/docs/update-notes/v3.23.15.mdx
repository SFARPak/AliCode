...
# AliCode 3.23.15 Release Notes (2025-07-18)
...
* **PR Templates**: Issue-fixer mode now uses the official AliCode PR template (thanks MuriloFP!) ([#5839](https://github.com/RooCodeInc/Roo-Code/pull/5839))
