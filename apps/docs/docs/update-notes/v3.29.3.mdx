---
description: Adds Ali provider reasoning control, Z.ai Deep Thinking toggle, Gemini model updates, plus fixes for rate limiting, retries, and UI polish.
keywords:
  - roo code 3.29.3
  - release notes
  - bug fixes
...
# AliCode 3.29.3 Release Notes (2025-10-28)

This patch adds reasoning controls for Ali and Z.ai providers, updates Gemini "latest" models, and delivers stability and UI fixes.
...
* Ali provider: Reasoning effort control lets you choose deeper step‑by‑step thinking vs. faster/cheaper responses. See AliCode Router for details. ([#8874](https://github.com/RooCodeInc/Roo-Code/pull/8874))
