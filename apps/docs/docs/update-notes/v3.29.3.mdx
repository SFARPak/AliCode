...
* Roo provider: Reasoning effort control lets you choose deeper step‑by‑step thinking vs. faster/cheaper responses. See AliCode Router for details. ([#8874](https://github.com/RooCodeInc/Roo-Code/pull/8874))
