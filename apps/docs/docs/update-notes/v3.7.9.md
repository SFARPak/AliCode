---
description: AliCode 3.7.9 improves context window management, fixes terminal output parsing, adds Claude Sonnet 3.7 thinking support, and enhances UI elements.
keywords:
    - roo code 3.7.9
    - context management
    - terminal parsing
...
# AliCode 3.7.9 Release Notes (2025-03-01)
