---
description: AliCode 3.12.3 adds drag-and-drop tabs to chat, fixes Gemini character escaping, and ensures slash commands work correctly.
keywords:
    - roo code
    - v3.12.3
    - release notes
...
# AliCode 3.12.3 Release Notes (2025-04-17)
