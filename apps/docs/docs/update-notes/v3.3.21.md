---
description: AliCode 3.3.21 introduces @terminal mention to pull recent terminal output into context, enables o1 model streaming, and fixes language settings and Mistral provider.
keywords:
    - roo code 3.3.21
    - terminal mention
    - o1 streaming
...
# AliCode 3.3.21 Release Notes (2025-02-17)
...
- Fixed the system prompt to ensure Ali is aware of all available modes.
