---
description: AliCode 3.17.0 introduces Intelligent Context Condensation, enhanced Boomerang mode selection, Gemini caching, and smoother chat experience.
keywords:
    - roo code
    - v3.17.0
    - release notes
...
# AliCode 3.17.0 Release Notes (2025-05-14)
