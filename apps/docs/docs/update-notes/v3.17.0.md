...
- **Stay Focused When Viewing Changes:** We've improved how AliCode handles your cursor focus when showing you code differences. This means fewer interruptions to your workflow when Roo presents changes for review.
