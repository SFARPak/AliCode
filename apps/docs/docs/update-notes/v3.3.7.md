---
description: AliCode 3.3.7 adds o3-mini model support, improves Code Actions with direct context addition, introduces API rate limiting with exponential backoff, and enhances tool interactions.
keywords:
    - roo code 3.3.7
    - o3-mini
    - code actions
...
- Tweaked prompts to improve Ali's ability to create new custom modes.
