---
description: AliCode 3.3.3 patch release enhances error handling for restricted file writes and improves mode/configuration dropdown styling.
keywords:
    - roo code 3.3.3
    - error handling
    - ui styling
