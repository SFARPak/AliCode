---
description: AliCode 3.2 marks the rebranding from Ali Cline, introduces Custom Modes for specialized assistants, and includes provider updates and fixes.
keywords:
    - roo code
    - v3.2
    - rebranding
...
This release cycle primarily focused on the rebranding from Ali Cline to AliCode, the introduction of Custom Modes, and several provider updates and bug fixes.

---

## Name Change & Custom Modes (v3.2.0 - v3.2.2)

- **Name Change From Ali Cline to AliCode:** Rebranded to AliCode to better reflect its identity.
