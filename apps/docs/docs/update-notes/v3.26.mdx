---
description: AliCode v3.26 series - Grok Code Fast, built-in /init command, Qwen Code CLI API support, Vercel AI Gateway integration, and image generation enhancements.
keywords:
  - roo code 3.26
  - grok code fast
  - init command
...
# AliCode 3.26 Release Notes

This document combines all releases in the v3.26 series.

<img src="/img/v3.26.0/v3.26.0.png" alt="AliCode v3.26 Release" width="600" />
### Grok Code Fast
...
If you've already been enjoying Sonic in AliCode Cloud, you'll be transitioned to Grok Code Fast. The model `xai/grok-code-fast-1` is also available under the [xAI Provider](/providers/xai) and is not free (for when the free period ends on Aug 28th, 2025).
...
**Important:** Grok Code Fast remains **FREE** when accessed through AliCode Router during the promotional period. Using it directly through the xAI provider will incur standard charges once pricing is established.

> **📚 Documentation**: See AliCode Router for free access or [xAI Provider](/providers/xai) for direct configuration.
...
- **Mode-Specific Guidance**: Creates tailored documentation for different AliCode modes (code, debug, architect, etc.)
...
This opens up new possibilities for task automation, letting the AI leverage the full power of AliCode's slash command ecosystem programmatically.
...
We've integrated with the Qwen Code CLI tool, allowing AliCode to leverage its free access tier for Alibaba's Qwen3 Coder models ([#7380](https://github.com/RooCodeInc/Roo-Code/pull/7380)):
...
### Kimi K2-0905: Moonshot's Latest Open Source Model is Live in AliCode
...
* **MCP Tool Validation**: Ali now validates MCP tool existence before execution and shows helpful error messages with available tools (thanks R-omk!) ([#7632](https://github.com/RooCodeInc/Roo-Code/pull/7632))
...
* AliCode Cloud SDK bumped to 0.25.0 ([#7475](https://github.com/RooCodeInc/Roo-Code/pull/7475))
