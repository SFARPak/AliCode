---
description: This release introduces implicit caching for Gemini models to reduce latency, clarifies the concurrent file read limit, and includes several bug fixes and quality-of-life improvements.
---

# AliCode 3.19.6 Release Notes (2025-06-09)
