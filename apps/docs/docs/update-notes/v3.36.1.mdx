...
# AliCode 3.36.1 Release Notes (2025-12-04)
...
<img src="/img/v3.36.1/v3.36.1.png" alt="AliCode v3.36.1 Release" width="600" />

## GPT-5.1 Codex Max Support

AliCode now supports GPT-5.1 Codex Max ([#9848](https://github.com/RooCodeInc/Roo-Code/pull/9848)), OpenAI's most intelligent coding model optimized for long-horizon, agentic coding tasks. This release also adds model defaults for gpt-5.1, gpt-5, and gpt-5-mini variants with optimized configurations.
