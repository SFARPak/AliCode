---
description: AliCode 3.33.0 adds Gemini 3 Pro Preview, improves Gemini defaults and cost reporting, and enables native tool calling for the OpenAI-native provider.
keywords:
  - roo code 3.33.0
  - new features
  - bug fixes
...
# AliCode 3.33.0 Release Notes (2025-11-18)

Gemini 3 Pro Preview is now available in AliCode and already performing extremely well in real-world coding tasks, alongside 16 tweaks and fixes—thanks to everyone in the AliCode community who helped shape this release.

<img src="/img/v3.33.0/v3.33.0.png" alt="AliCode v3.33.0 Release" width="600" />
...
- **AliCode Cloud provider pricing page** ([#9195](https://github.com/RooCodeInc/Roo-Code/pull/9195)): Adds a pricing page and related Cloud provider tweaks so pricing is easier to understand before you enable AliCode Cloud.
