...
# AliCode 3.28.9 Release Notes (2025-09-26)
...
<img src="/img/v3.28.9/v3.28.9.png" alt="AliCode v3.28.9 Release" width="600" />
...
Quick start: https://app.alicode.com/l/supernova
...
* **Discover AliCode Cloud faster in the welcome screen**: Experiment to show the Ali provider on the welcome screen (localized strings with click telemetry) to speed up setup. ([#8317](https://github.com/RooCodeInc/Roo-Code/pull/8317))
