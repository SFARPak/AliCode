---
description: AliCode 3.11.4 adds tree-sitter support for TSX, TypeScript, JSON, and Markdown, fixes Windows unit tests, improves UI elements, and enhances provider support.
keywords:
    - roo code 3.11.4
    - tree-sitter
    - tsx support
...
# AliCode 3.11.4 Release Notes (2025-04-02)
