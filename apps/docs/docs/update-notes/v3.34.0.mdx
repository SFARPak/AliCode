...
# AliCode 3.34.0 Release Notes (2025-11-21)

This release introduces Browser Use 2.0 for richer web automation, adds the Baseten provider, improves OpenAI-compatible behavior, and refines onboarding and native tool descriptions to make it easier for Ali to understand and use your tools effectively.

<img src="/img/v3.34.0/v3.34.0.png" alt="AliCode v3.34.0 Release" width="600" />
