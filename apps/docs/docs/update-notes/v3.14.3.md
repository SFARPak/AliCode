---
description: AliCode 3.14.3 adds Boomerang Orchestrator as default mode, features a new minimalist home screen, and improves token estimation.
keywords:
    - roo code
    - v3.14.3
    - release notes
...
# AliCode 3.14.3 Release Notes (2025-04-25)
