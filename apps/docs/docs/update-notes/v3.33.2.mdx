---
description: Patch release adding Gemini native tool calling, in-extension AliCode Cloud credit visibility, clearer free model pricing, and native tool reliability fixes.
keywords:
  - roo code 3.33.2
  - new features
  - bug fixes
...
# AliCode 3.33.2 Release Notes (2025-11-20)

This patch release focuses on Gemini native tool calling, making AliCode Cloud usage more visible, clarifying which models are free, and improving native tool reliability and performance.
...
* **AliCode Cloud credit balance in the extension**: Show your AliCode Cloud RCC credit balance directly in the Roo provider settings when signed in, helping you track usage and avoid unexpected interruptions. ([#9386](https://github.com/RooCodeInc/Roo-Code/pull/9386))
