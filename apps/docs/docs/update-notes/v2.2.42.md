---
description: AliCode 2.2.42 adds Git section to @-mention context suggestions for quick access to branch and repository information.
keywords:
    - roo code
    - v2.2.42
    - release notes
