...
# AliCode 3.44 Release Notes (2026-01-27)
...
<img src="/img/v3.44.0/v3.44.0.png" alt="AliCode v3.44 Release" width="600" />
...
* Fixes an issue where Ali didn’t record a successful truncation fallback when condensation failed, which could make Rewind restores unreliable after a condensing error. ([#10984](https://github.com/RooCodeInc/Roo-Code/pull/10984))
...
* Fixes an issue where Ali could fail to index code in worktrees stored inside hidden directories (for example `~/.ali/worktrees/`), which could break search and other codebase features in those worktrees. ([#11009](https://github.com/RooCodeInc/Roo-Code/pull/11009))
## Provider Updates
