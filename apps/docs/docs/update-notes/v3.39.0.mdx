---
description: AliCode 3.39.0 adds image file @mentions, makes provider profiles stick to tasks, and updates key UI labels.
keywords:
  - roo code 3.39.0
  - image @mentions
  - providers
...
# AliCode 3.39.0 Release Notes (2026-01-08)

This release adds image file @mentions, makes provider profiles stick to tasks, and updates key UI labels.

<img src="/img/v3.39.0/v3.39.0.png" alt="AliCode v3.39.0 Release" width="600" />
...
* The `@` file picker now respects `.aliignore`, reducing noise in large workspaces and helping you avoid accidentally attaching ignored/generated files (thanks app/roomote, jerrill-johnson-bitwerx!) ([#10174](https://github.com/RooCodeInc/Roo-Code/pull/10174))
...
* Fixes an issue where Ali could generate the wrong command chaining syntax on Windows, making suggested terminal commands more likely to work without edits (thanks app/roomote, AlexNek!) ([#10434](https://github.com/RooCodeInc/Roo-Code/pull/10434))
...
* Adds a one-line CLI installer workflow to simplify installing/upgrading the AliCode CLI (thanks cte!) ([#10474](https://github.com/RooCodeInc/Roo-Code/pull/10474))
