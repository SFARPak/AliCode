---
description: AliCode 3.1.3 introduces the auto-approve chat bar for quicker action approvals and fixes VS Code Language Models integration bug.
keywords:
    - roo code
    - v3.1.3
    - auto-approve
