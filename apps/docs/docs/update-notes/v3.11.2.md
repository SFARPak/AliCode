---
description: AliCode 3.11.2 fixes Requesty API key balance loading, resolves Bedrock inference profile issues, and improves webview message handling for better stability.
keywords:
    - roo code 3.11.2
    - requesty api
    - bedrock inference
...
# AliCode 3.11.2 Release Notes (2025-03-31)
