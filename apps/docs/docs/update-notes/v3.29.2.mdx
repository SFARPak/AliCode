---
description: AliCode 3.29.2 adds higher-context Chutes AI models, improves settings text, and fixes provider caching and free-model pricing display.
keywords:
  - roo code 3.29.2
  - chutes ai
  - longcat
...
# AliCode 3.29.2 Release Notes (2025-10-27)
...
* Ali provider: Fix caching logic to emit correct usage data and apply proper protocol ([#8860](https://github.com/RooCodeInc/Roo-Code/pull/8860))
