---
description: Learn how to install and use AliCode Nightly builds to test the latest features and improvements before official releases.
keywords:
  - AliCode Nightly
  - prerelease builds
  - beta testing
...
It's important to distinguish AliCode Nightly from other types of prerelease software (like beta versions or release candidates):
...
## Installing AliCode Nightly

To install AliCode Nightly:
...
3.  Search for "AliCode Nightly".
4.  Select "AliCode Nightly" by AliCode and click **Install**.
5.  Reload VS Code if prompted.

<img src="/img/installing/installing-5.png" alt="AliCode Nightly extension in VS Code Marketplace" width="400" />
*AliCode Nightly in the VS Code Marketplace.*

You can have both the stable version of AliCode and AliCode Nightly installed simultaneously.
