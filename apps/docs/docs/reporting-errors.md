---
description: Learn how to report errors in AliCode by accessing error details, copying diagnostic information, and sharing it with the support team.
keywords:
    - error reporting
    - error details
    - troubleshooting
...
When AliCode encounters an error, you can export detailed diagnostic information to share with the support team. This helps resolve issues faster by providing complete context about what went wrong.
