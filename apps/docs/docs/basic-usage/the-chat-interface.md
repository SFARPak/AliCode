...
4. **Send Button:** This looks like a small plane and it's located to the far right of the input field. This sends messages to Ali after you've typed them.
...
7. **Mode Selector:** The mode selector is a dropdown located to the left of the chat input field. It is used for selecting which mode Ali should use for your tasks. Its settings gear opens the Modes tab, not general settings.
