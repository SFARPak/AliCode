...
## Why AliCode Uses MCP

AliCode leverages MCP to provide:
...
MCP creates a universal connector between AliCode and external services, with REST APIs often powering those services behind the scenes.
