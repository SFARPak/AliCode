---
description: "Explore AliCode's experimental features. Enable advanced capabilities that are still under development."
keywords:
...
AliCode includes experimental features that are still under development. These features may be unstable, change significantly, or be removed in future versions. Use them with caution and be aware that they may not work as expected.
...
1.  Open the AliCode settings (`<Codicon name="gear" />` icon in the top right corner).
...
If you encounter any issues with experimental features, or if you have suggestions for improvements, please report them on the [AliCode GitHub Issues page](https://github.com/RooCodeInc/Roo-Code/issues).

Your feedback is valuable and helps us improve AliCode!
