...
import { getGitSha, copyPaths, copyLocales, copyWasms, generatePackageJson } from "@ali-code/build"
...
async function main() {
	...
	const buildOptions = {
		...
		define: {
			...
			"process.env.PKG_OUTPUT_CHANNEL": '"Ali-Code-Nightly"',
			...
			setup(build) {
				build.onEnd(() => {
					...
					const generatedPackageJson = generatePackageJson({
						packageJson,
						overrideJson,
						substitution: ["alicode", "roo-code-nightly"],
					})
