...
Ali Code s'adapta a la teva manera de treballar, no a l'inrevés:
...
Més informació: [Ús de Modes](https://alicodeinc.github.io/Ali-Code/basic-usage/using-modes) • [Modes personalitzats](https://alicodeinc.github.io/Ali-Code/advanced-usage/custom-modes)

## Recursos

- **[Documentació](https://alicodeinc.github.io/Ali-Code/):** La guia oficial per instal·lar, configurar i dominar Ali Code.
- **[Incidències de GitHub](https://github.com/AliCodeInc/Ali-Code/issues):** Informa d'errors i segueix el desenvolupament.

---

## Avís legal

**Tingueu en compte** que Ali Code, Inc **no** fa cap representació ni garantia pel que fa a cap codi, model o altres eines proporcionades o posades a disposició en relació amb Ali Code, qualsevol eina de tercers associada, o qualsevol resultat. Assumiu **tots els riscos** associats amb l'ús d'aquestes eines o resultats; aquestes eines es proporcionen **"TAL QUAL"** i **"SEGONS DISPONIBILITAT"**. Aquests riscos poden incloure, sense limitació, infraccions de propietat intel·lectual, vulnerabilitats o atacs cibernètics, biaix, inexactituds, errors, defectes, virus, temps d'inactivitat, pèrdua o dany de propietat i/o lesions personals. Sou l'únic responsable del vostre ús d'aquestes eines o resultats (incloent, sense limitació, la legalitat, idoneïtat i resultats dels mateixos).
