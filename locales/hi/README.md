...
## Ali Code आपके लिए क्या कर सकता है?
...
और जानो: [मोड्स का इस्तेमाल](https://alicodeinc.github.io/Ali-Code/basic-usage/using-modes) • [कस्टम मोड्स](https://alicodeinc.github.io/Ali-Code/advanced-usage/custom-modes)

## संसाधन

- **[दस्तावेज़ीकरण](https://alicodeinc.github.io/Ali-Code/):** Ali Code को स्थापित करने, कॉन्फ़िगर करने और उसमें महारत हासिल करने के लिए आधिकारिक गाइड।
- **[गिटहब मुद्दे](https://github.com/AliCodeInc/Ali-Code/issues):** बग की रिपोर्ट करें और विकास को ट्रैक करें।
