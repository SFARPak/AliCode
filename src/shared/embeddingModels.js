...
exports.EMBEDDING_MODEL_PROFILES = void 0
exports.getModelDimension = getModelDimension
exports.getModelScoreThreshold = getModelScoreThreshold
exports.getModelQueryPrefix = getModelQueryPrefix
exports.getDefaultModelId = getDefaultModelId
// Example profiles - expand this list as needed
exports.EMBEDDING_MODEL_PROFILES = {
	openai: {
 ...
 */
function getModelDimension(provider, modelId) {
	const providerProfiles = exports.EMBEDDING_MODEL_PROFILES[provider]
	if (!providerProfiles) {
 ...
 */
function getModelScoreThreshold(provider, modelId) {
	const providerProfiles = exports.EMBEDDING_MODEL_PROFILES[provider]
	if (!providerProfiles) {
		return undefined
	}
 ...
 */
function getModelQueryPrefix(provider, modelId) {
	const providerProfiles = exports.EMBEDDING_MODEL_PROFILES[provider]
	if (!providerProfiles) {
		return undefined
	}
...
function getDefaultModelId(provider) {
	switch (provider) {
		...
		case "ollama": {
			...
			const ollamaModels = exports.EMBEDDING_MODEL_PROFILES.ollama
