...
exports.supportPrompt = exports.createPrompt = void 0
...
const createPrompt = (template, params) => {
...
exports.supportPrompt = {
	...
	create: (type, params, customSupportPrompts) => {
		const template = exports.supportPrompt.get(customSupportPrompts, type)
		return (0, exports.createPrompt)(template, params)
	},
}
