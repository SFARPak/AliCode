...
exports.commandRegexGlobal = exports.mentionRegexGlobal = exports.mentionRegex = void 0
exports.formatGitSuggestion = formatGitSuggestion
...
*/
exports.mentionRegex =
	/(?:^|(?<=\s))(?<!\\)@((?:\/|\w+:\/\/)(?:[^\s\\]|\\ )+?|[a-f0-9]{7,40}\b|problems\b|git-changes\b|terminal\b)(?=[.,;:!?]?(?=[\s\r\n]|$))/
exports.mentionRegexGlobal = new RegExp(exports.mentionRegex.source, "g")
// Regex to match command mentions like /command-name anywhere in text
exports.commandRegexGlobal = /(?:^|\s)\/([a-zA-Z0-9_\.-]+)(?=\s|$)/g
function formatGitSuggestion(commit) {
	return {
		type: "git",
