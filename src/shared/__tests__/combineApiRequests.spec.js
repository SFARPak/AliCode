...
const combineApiRequests_1 = require("../combineApiRequests")
describe("combineApiRequests", () => {
	// Helper function to create a basic api_req_started message
	const createStartMessage = (text = '{"request":"GET /api/data"}', ts = 1000) => ({
		type: "say",
		say: "api_req_started",
		text,
		ts,
	...
	const createFinishMessage = (text = '{"cost":0.005}', ts = 1001) => ({
		type: "say",
	...
	const createOtherMessage = (say = "text", text = "Hello world", ts = 999) => ({ type: "say", say, text, ts })
	describe("Basic functionality", () => {
		it("should combine a pair of api_req_started and api_req_finished messages", () => {
			const messages = [createStartMessage(), createFinishMessage()]
			const result = (0, combineApiRequests_1.combineApiRequests)(messages)
		...
		it("should preserve non-API messages", () => {
			...
			const messages = [otherMessage, createStartMessage(), createFinishMessage()]
			const result = (0, combineApiRequests_1.combineApiRequests)(messages)
	...
	describe("Edge cases", () => {
		it("should handle empty messages array", () => {
			const result = (0, combineApiRequests_1.combineApiRequests)([])
		...
		it("should handle missing text field in api_req_started", () => {
			...
			const messages = [startMessage, finishMessage]
			const result = (0, combineApiRequests_1.combineApiRequests)(messages)
			// Should have one message (the combined one)
			expect(result).toHaveLength(1)
	...
	describe("Bug verification", () => {
		it("should correctly replace api_req_started messages with combined ones", () => {
			...
			const messages = [otherMessage, startMessage1, finishMessage1, startMessage2]
			const result = (0, combineApiRequests_1.combineApiRequests)(messages)
