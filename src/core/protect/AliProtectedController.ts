 ...
 */
export class AliProtectedController {
	private cwd: string
	...
	getInstructions(): string {
		...
		return `# Protected Files\n\n(The following Ali configuration file patterns are write-protected and always require approval for modifications, regardless of autoapproval settings. When using list_files, you'll notice a ${SHIELD_SYMBOL} next to files that are write-protected.)\n\nProtected patterns: ${patterns}`
	}
