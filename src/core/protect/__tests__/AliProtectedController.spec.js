...
const AliProtectedController_1 = require("../AliProtectedController")
describe("AliProtectedController", () => {
	const TEST_CWD = "/test/workspace"
	let controller
	beforeEach(() => {
		controller = new AliProtectedController_1.AliProtectedController(TEST_CWD)
	})
	describe("isWriteProtected", () => {
		...
		it("should handle absolute paths by converting to relative", () => {
			const absolutePath = path_1.default.join(TEST_CWD, ".aliignore")
	...
	describe("getProtectedPatterns", () => {
		it("should return the list of protected patterns", () => {
			const patterns = AliProtectedController_1.AliProtectedController.getProtectedPatterns()
