...
exports.getCommandChainOperator = getCommandChainOperator
exports.getRulesSection = getRulesSection
 ...
 */
function getCommandChainOperator() {
	const shell = (0, shell_1.getShell)().toLowerCase()
...
function getVendorConfidentialitySection() {
	return `
