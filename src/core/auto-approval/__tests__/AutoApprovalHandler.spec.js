...
const AutoApprovalHandler_1 = require("../AutoApprovalHandler")
...
describe("AutoApprovalHandler", () => {
	let handler
	let mockAskForApproval
	let mockState
	const mockGetApiMetrics = getApiMetrics_1.getApiMetrics
	beforeEach(() => {
		handler = new AutoApprovalHandler_1.AutoApprovalHandler()
