...
describe("apply-patch apply", () => {
	describe("applyChunksToContent", () => {
		it("should apply simple replacement", () => {
			...
			const result = (0, apply_1.applyChunksToContent)(original, "test.txt", chunks)
		...
		it("should use context to find location", () => {
			...
			const result = (0, apply_1.applyChunksToContent)(original, "test.py", chunks)
		...
		it("should throw when context not found", () => {
			...
			expect(() => (0, apply_1.applyChunksToContent)(original, "test.txt", chunks)).toThrow(
				apply_1.ApplyPatchError,
			)
			expect(() => (0, apply_1.applyChunksToContent)(original, "test.txt", chunks)).toThrow(
