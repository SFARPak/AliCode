...
describe("apply_patch parser", () => {
	describe("parsePatch", () => {
		it("should reject patch without Begin Patch marker", () => {
			expect(() => (0, parser_1.parsePatch)("bad")).toThrow(parser_1.ParseError)
			expect(() => (0, parser_1.parsePatch)("bad")).toThrow(
				"The first line of the patch must be '*** Begin Patch'",
			)
		})
		it("should reject patch without End Patch marker", () => {
			expect(() => (0, parser_1.parsePatch)("*** Begin Patch\nbad")).toThrow(parser_1.ParseError)
			expect(() => (0, parser_1.parsePatch)("*** Begin Patch\nbad")).toThrow(
				"The last line of the patch must be '*** End Patch'",
			)
		})
		it("should parse empty patch", () => {
			const result = (0, parser_1.parsePatch)("*** Begin Patch\n*** End Patch")
...
*** End Patch`)
		...
		it("should reject empty Update File hunk", () => {
			expect(() =>
				(0, parser_1.parsePatch)(`*** Begin Patch
*** Update File: test.py
*** End Patch`),
			).toThrow(parser_1.ParseError)
		})
		it("should handle heredoc-wrapped patches (lenient mode)", () => {
			const result = (0, parser_1.parsePatch)(`<<EOF
*** Begin Patch
*** Add File: foo
+hi
*** End Patch
