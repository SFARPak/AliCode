...
const SearchReplaceTool_1 = require("../SearchReplaceTool")
vi.mock("fs/promises", () => ({
	default: {
...
describe("searchReplaceTool", () => {
	...
	beforeEach(() => {
		...
		mockCline.aliProtectedController = {
	 ...
	 */
	async function executeSearchReplaceTool(params = {}, options = {}) {
		...
		await SearchReplaceTool_1.searchReplaceTool.handle(mockCline, toolUse, {
