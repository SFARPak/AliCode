...
exports.readCommandOutputTool = exports.ReadCommandOutputTool = void 0
 ...
 * ```
 */
class ReadCommandOutputTool extends BaseTool_1.BaseTool {
	 ...
	 * @private
	 */
	async readArtifact(artifactPath, offset, limit, totalSize) {
	 ...
	 * @private
	 */
	async searchInArtifact(artifactPath, pattern, totalSize, limit) {
	 ...
	 * @private
	 */
	async countNewlinesBeforeOffset(fileHandle, offset) {
...
exports.ReadCommandOutputTool = ReadCommandOutputTool
/** Singleton instance of the ReadCommandOutputTool */
exports.readCommandOutputTool = new ReadCommandOutputTool()
