...
describe("Context Management", () => {
	...
	describe("manageContext", () => {
		...
		it("should not truncate if tokens are below max tokens threshold", async () => {
			...
			const result = await (0, index_1.manageContext)({
		...
		it("should work with non-prompt caching models the same as prompt caching models", async () => {
			...
			const result1 = await (0, index_1.manageContext)({
				messages: messagesWithSmallContent,
			...
			const result2 = await (0, index_1.manageContext)({
				messages: messagesWithSmallContent,
				totalTokens: belowThreshold,
			...
			const result3 = await (0, index_1.manageContext)({
				messages: messagesWithSmallContent,
			...
			const result4 = await (0, index_1.manageContext)({
				messages: messagesWithSmallContent,
				totalTokens: aboveThreshold,
				contextWindow: modelInfo2.contextWindow,
				maxTokens: modelInfo2.maxTokens,
		...
		it("should consider incoming content when deciding to truncate", async () => {
			...
			const resultWithSmall = await (0, index_1.manageContext)({
				messages: messagesWithSmallContent,
			...
			const resultWithLarge = await (0, index_1.manageContext)({
			...
			const resultWithVeryLarge = await (0, index_1.manageContext)({
	...
	describe("willManageContext", () => {
		it("should return true when context percent exceeds threshold", () => {
			const result = (0, index_1.willManageContext)({
				totalTokens: 60000,
		...
		it("should include lastMessageTokens in the calculation", () => {
			...
			const resultWithoutLastMessage = (0, index_1.willManageContext)({
				totalTokens: 49000,
				contextWindow: 100000,
				maxTokens: 30000,
				autoCondenseContext: true,
			...
			const resultWithLastMessage = (0, index_1.willManageContext)({
				totalTokens: 49000,
				contextWindow: 100000,
				maxTokens: 30000,
				autoCondenseContext: true,
	...
	describe("newContextTokensAfterTruncation", () => {
		...
		it("should include system prompt tokens in newContextTokensAfterTruncation", async () => {
			...
			const systemPromptTokens = await (0, index_1.estimateTokenCount)(
