...
describe("webviewMessageHandler - searchFiles with RooIgnore filtering", () => {
	...
	beforeEach(() => {
		...
		;(AliIgnoreController.prototype as any).filterPaths = mockFilterPaths
		;(AliIgnoreController.prototype as any).initialize = vi.fn().mockResolvedValue(undefined)
		;(AliIgnoreController.prototype as any).dispose = mockDispose
	...
	it("should filter results using AliIgnoreController when showAliIgnoredFiles is false", async () => {
		...
		// Setup state with showAliIgnoredFiles = false
	...
	it("should not filter results when showAliIgnoredFiles is true", async () => {
		...
		// Setup state with showAliIgnoredFiles = true
		;(mockClineProvider.getState as Mock).mockResolvedValue({
