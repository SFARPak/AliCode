...
import { type ModeConfig, type PromptComponent, customModesSettingsSchema, modeConfigSchema } from "@ali-code/types"

import { fileExistsAtPath } from "../../utils/fs"
import { getWorkspacePath } from "../../utils/path"
import { getGlobalAliDirectory } from "../../services/ali-config"
	...
	public async checkRulesDirectoryHasContent(slug: string): Promise<boolean> {
		try {
			...
			if (isGlobalMode) {
				...
				const globalAliDir = getGlobalAliDirectory()
