"use strict"
// npx vitest core/ignore/__tests__/AliIgnoreController.security.spec.ts
var __createBinding =
...
const AliIgnoreController_1 = require("../AliIgnoreController")
...
describe("AliIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .aliignore to exist with some patterns
		mockFileExists.mockResolvedValue(true)
		mockReadFile.mockResolvedValue("node_modules\n.git\nsecrets/**\n*.log\nprivate/")
		// Create and initialize controller
		controller = new AliIgnoreController_1.AliIgnoreController(TEST_CWD)
