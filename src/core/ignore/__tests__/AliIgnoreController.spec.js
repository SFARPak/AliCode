"use strict"
// npx vitest core/ignore/__tests__/AliIgnoreController.spec.ts
var __createBinding =
...
describe("AliIgnoreController", () => {
	...
	describe("validateAccess", () => {
		...
		it("should allow all access when no .aliignore content", async () => {
			...
			mockFileExists.mockResolvedValue(false)
			const emptyController = new AliIgnoreController_1.AliIgnoreController(TEST_CWD)
