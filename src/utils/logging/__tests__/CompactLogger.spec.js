...
describe("CompactLogger", () => {
	...
	let logger
	beforeEach(() => {
		transport = new MockTransport_1.MockTransport()
		logger = new CompactLogger_1.CompactLogger(transport)
	})
	afterEach(() => {
		transport.clear()
	})
	...
	describe("Child Loggers", () => {
		test("creates child logger with inherited metadata", () => {
			...
			const parentLogger = new CompactLogger_1.CompactLogger(transport, parentMeta)
		...
		test("child logger respects parent context when not overridden", () => {
			const parentLogger = new CompactLogger_1.CompactLogger(transport, { ctx: "parent" })
	...
	describe("Child Logger Edge Cases", () => {
		test("deeply nested child loggers maintain correct metadata inheritance", () => {
			const root = new CompactLogger_1.CompactLogger(transport, { ctx: "root", rootVal: 1 })
		...
		test("child logger with empty metadata inherits parent metadata unchanged", () => {
			const parent = new CompactLogger_1.CompactLogger(transport, { ctx: "parent", data: "value" })
