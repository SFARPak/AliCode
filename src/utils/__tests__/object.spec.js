...
describe("isEmpty", () => {
	describe("should return true for empty values", () => {
		it.each([
			...
			expect((0, object_1.isEmpty)(value)).toBe(true)
		})
	})
	describe("should return false for non-empty values", () => {
		it.each([
			...
			expect((0, object_1.isEmpty)(value)).toBe(false)
		})
	})
	it("should handle objects with null prototype", () => {
		const obj = Object.create(null)
		expect((0, object_1.isEmpty)(obj)).toBe(true)
		obj.prop = "value"
		expect((0, object_1.isEmpty)(obj)).toBe(false)
	})
})
