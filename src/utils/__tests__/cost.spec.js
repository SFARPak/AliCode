...
describe("Cost Utility", () => {
	describe("calculateApiCostAnthropic", () => {
		...
		it("should calculate basic input/output costs correctly", () => {
			const result = (0, cost_1.calculateApiCostAnthropic)(mockModelInfo, 1000, 500)
		...
		it("should handle cache writes cost", () => {
			const result = (0, cost_1.calculateApiCostAnthropic)(mockModelInfo, 1000, 500, 2000)
			// Input cost: (3.0 / 1_000_000) * 1000 = 0.003
			// Output cost: (15.0 / 1_000_000) * 500 = 0.0075
		...
		it("should handle cache reads cost", () => {
			const result = (0, cost_1.calculateApiCostAnthropic)(mockModelInfo, 1000, 500, undefined, 3000)
			// Input cost: (3.0 / 1_000_000) * 1000 = 0.003
			// Output cost: (15.0 / 1_000_000) * 500 = 0.0075
		...
		it("should handle all cost components together", () => {
			const result = (0, cost_1.calculateApiCostAnthropic)(mockModelInfo, 1000, 500, 2000, 3000)
			// Input cost: (3.0 / 1_000_000) * 1000 = 0.003
			// Output cost: (15.0 / 1_000_000) * 500 = 0.0075
			// Cache writes: (3.75 / 1_000_000) * 2000 = 0.0075
			// Cache reads: (0.3 / 1_000_000) * 3000 = 0.0009
		...
		it("should handle missing prices gracefully", () => {
			...
			const result = (0, cost_1.calculateApiCostAnthropic)(modelWithoutPrices, 1000, 500, 2000, 3000)
			expect(result.totalCost).toBe(0)
			expect(result.totalInputTokens).toBe(6000) // 1000 + 2000 + 3000
			expect(result.totalOutputTokens).toBe(500)
		})
		it("should handle zero tokens", () => {
			const result = (0, cost_1.calculateApiCostAnthropic)(mockModelInfo, 0, 0, 0, 0)
			expect(result.totalCost).toBe(0)
		...
		it("should handle missing cache prices", () => {
			...
			const result = (0, cost_1.calculateApiCostAnthropic)(modelWithoutCachePrices, 1000, 500, 2000, 3000)
	...
	describe("calculateApiCostOpenAI", () => {
		...
		it("should calculate basic input/output costs correctly", () => {
			const result = (0, cost_1.calculateApiCostOpenAI)(mockModelInfo, 1000, 500)
			// Input cost: (3.0 / 1_000_000) * 1000 = 0.003
			// Output cost: (15.0 / 1_000_000) * 500 = 0.0075
			// Total: 0.003 + 0.0075 = 0.0105
			expect(result.totalCost).toBe(0.0105)
		...
		it("should handle cache writes cost", () => {
			const result = (0, cost_1.calculateApiCostOpenAI)(mockModelInfo, 3000, 500, 2000)
		...
		it("should handle cache reads cost", () => {
			const result = (0, cost_1.calculateApiCostOpenAI)(mockModelInfo, 4000, 500, undefined, 3000)
		...
		it("should handle all cost components together", () => {
			const result = (0, cost_1.calculateApiCostOpenAI)(mockModelInfo, 6000, 500, 2000, 3000)
		...
		it("should handle missing prices gracefully", () => {
			...
			const result = (0, cost_1.calculateApiCostOpenAI)(modelWithoutPrices, 1000, 500, 2000, 3000)
			expect(result.totalCost).toBe(0)
			expect(result.totalInputTokens).toBe(1000) // Total already includes cache
			expect(result.totalOutputTokens).toBe(500)
		})
		it("should handle zero tokens", () => {
			const result = (0, cost_1.calculateApiCostOpenAI)(mockModelInfo, 0, 0, 0, 0)
			expect(result.totalCost).toBe(0)
			expect(result.totalInputTokens).toBe(0)
			expect(result.totalOutputTokens).toBe(0)
		})
		...
		it("should handle missing cache prices", () => {
			...
			const result = (0, cost_1.calculateApiCostOpenAI)(modelWithoutCachePrices, 6000, 500, 2000, 3000)
			// Should only include input and output costs
			// Input cost: (3.0 / 1_000_000) * (6000 - 2000 - 3000) = 0.003
			// Output cost: (15.0 / 1_000_000) * 500 = 0.0075
			// Total: 0.003 + 0.0075 = 0.0105
		...
		it("should not apply long-context pricing at the threshold", () => {
			const modelWithLongContextPricing = {
				...mockModelInfo,
				longContextPricing: {
			...
			const result = (0, cost_1.calculateApiCostOpenAI)(
