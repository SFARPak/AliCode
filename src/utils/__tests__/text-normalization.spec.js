...
describe("Text normalization utilities", () => {
	describe("normalizeString", () => {
		it("normalizes smart quotes by default", () => {
			expect(
				(0, text_normalization_1.normalizeString)(
		...
		it("normalizes typographic characters by default", () => {
			expect((0, text_normalization_1.normalizeString)("This has an em dash \u2014 and ellipsis\u2026")).toBe(
				"This has an em dash - and ellipsis...",
			)
		})
		it("normalizes whitespace by default", () => {
			expect((0, text_normalization_1.normalizeString)("Multiple   spaces and\t\ttabs")).toBe(
				"Multiple spaces and tabs",
			)
		})
		it("can be configured to skip certain normalizations", () => {
			const input = "Keep \u201Csmart quotes\u201D but normalize   whitespace"
			expect((0, text_normalization_1.normalizeString)(input, { smartQuotes: false })).toBe(
		...
		it("real-world example with mixed characters", () => {
			...
			expect((0, text_normalization_1.normalizeString)(input)).toBe(
	...
	describe("unescapeHtmlEntities", () => {
		it("unescapes basic HTML entities", () => {
			expect((0, text_normalization_1.unescapeHtmlEntities)("&lt;div&gt;Hello&lt;/div&gt;")).toBe(
				"<div>Hello</div>",
			)
		})
		it("unescapes ampersand entity", () => {
			expect((0, text_normalization_1.unescapeHtmlEntities)("This &amp; that")).toBe("This & that")
		})
		it("unescapes quote entities", () => {
			expect(
				(0, text_normalization_1.unescapeHtmlEntities)("&quot;quoted&quot; and &#39;single-quoted&#39;"),
			).toBe("\"quoted\" and 'single-quoted'")
		})
		it("unescapes apostrophe entity", () => {
			expect((0, text_normalization_1.unescapeHtmlEntities)("Don&apos;t worry")).toBe("Don't worry")
		})
		it("handles mixed content with multiple entity types", () => {
			expect(
				(0, text_normalization_1.unescapeHtmlEntities)(
		...
		it("returns original string when no entities are present", () => {
			...
			expect((0, text_normalization_1.unescapeHtmlEntities)(original)).toBe(original)
		})
		it("handles empty or undefined input", () => {
			expect((0, text_normalization_1.unescapeHtmlEntities)("")).toBe("")
			expect((0, text_normalization_1.unescapeHtmlEntities)(undefined)).toBe(undefined)
		})
		it("unescapes square bracket entities (numeric)", () => {
			expect((0, text_normalization_1.unescapeHtmlEntities)("string&#91;&#93;")).toBe("string[]")
			expect((0, text_normalization_1.unescapeHtmlEntities)("array&#91;0&#93;")).toBe("array[0]")
			expect((0, text_normalization_1.unescapeHtmlEntities)("matrix&#91;i&#93;&#91;j&#93;")).toBe("matrix[i][j]")
		})
		it("unescapes square bracket entities (named)", () => {
			expect((0, text_normalization_1.unescapeHtmlEntities)("string&lsqb;&rsqb;")).toBe("string[]")
			expect((0, text_normalization_1.unescapeHtmlEntities)("array&lsqb;0&rsqb;")).toBe("array[0]")
			expect((0, text_normalization_1.unescapeHtmlEntities)("matrix&lsqb;i&rsqb;&lsqb;j&rsqb;")).toBe(
				"matrix[i][j]",
			)
		})
