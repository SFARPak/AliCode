...
exports.MCP_TOOL_PREFIX = exports.MCP_TOOL_SEPARATOR = void 0
 ...
 */
exports.MCP_TOOL_SEPARATOR = "--"
/**
 * Prefix for all MCP tool function names.
 */
exports.MCP_TOOL_PREFIX = "mcp"
/**
...
function normalizeMcpToolName(toolName) {
	...
	if (normalized.startsWith("mcp__")) {
		...
		if (parts.length >= 3 && parts[0].toLowerCase() === "mcp") {
			...
			return `${exports.MCP_TOOL_PREFIX}${exports.MCP_TOOL_SEPARATOR}${serverName}${exports.MCP_TOOL_SEPARATOR}${toolNamePart}`
		}
	}
	return toolName
}
...
function isMcpTool(toolName) {
	const normalized = normalizeForComparison(toolName)
	return normalized.startsWith(`${exports.MCP_TOOL_PREFIX}__`)
}
/**
...
function buildMcpToolName(serverName, toolName) {
	...
	const fullName = `${exports.MCP_TOOL_PREFIX}${exports.MCP_TOOL_SEPARATOR}${sanitizedServer}${exports.MCP_TOOL_SEPARATOR}${sanitizedTool}`
...
function parseMcpToolName(mcpToolName) {
	...
	const separatorIndex = remainder.indexOf(exports.MCP_TOOL_SEPARATOR)
	if (separatorIndex === -1) {
		return null
	}
	const serverName = remainder.slice(0, separatorIndex)
	const toolName = remainder.slice(separatorIndex + exports.MCP_TOOL_SEPARATOR.length)
 ...
 */
function toolNamesMatch(name1, name2) {
