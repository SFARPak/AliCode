...
describe("TerminalProcess ANSI Handling", () => {
	let terminalProcess // Using any to access private methods
	let mockTerminal
	beforeEach(() => {
		mockTerminal = {
			shellIntegration: {
		...
		const terminalInfo = new Terminal_1.Terminal(1, mockTerminal, "/tmp")
		terminalProcess = new TerminalProcess_1.TerminalProcess(terminalInfo)
	})
