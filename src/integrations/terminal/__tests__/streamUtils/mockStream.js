...
exports.createBaseMockStream = createBaseMockStream
exports.createBashMockStream = createBashMockStream
exports.createCmdMockStream = createCmdMockStream
exports.createPowerShellMockStream = createPowerShellMockStream
exports.createChunkedMockStream = createChunkedMockStream
/**
 ...
 */
function createBaseMockStream(output, exitCode = 0) {
	const stream = {
 ...
 * @returns An object containing the stream and exit code
 */
function createBashMockStream(output, exitCode = 0) {
 ...
 * @returns An object containing the stream and exit code
 */
function createCmdMockStream(output, exitCode = 0) {
 ...
 * @returns An object containing the stream and exit code
 */
function createPowerShellMockStream(output, exitCode = 0) {
 ...
 * @returns An object containing the stream and exit code
 */
function createChunkedMockStream(output, chunkSize = 100, exitCode = 0) {
	const stream = {
		async *[Symbol.asyncIterator]() {
			// Start marker
			yield "\x1b]633;C\x07"
