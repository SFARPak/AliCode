...
import { AliTerminal, AliTerminalProvider } from "./types"
...
export class TerminalRegistry {
	private static terminals: AliTerminal[] = []
	...
	public static createTerminal(cwd: string, provider: AliTerminalProvider): AliTerminal {
		let newTerminal
	...
	public static async getOrCreateTerminal(
		cwd: string,
		taskId?: string,
		provider: AliTerminalProvider = "vscode",
	): Promise<AliTerminal> {
		const terminals = this.getAllTerminals()
		let terminal: AliTerminal | undefined
	 ...
	 */
	public static getTerminals(busy: boolean, taskId?: string): AliTerminal[] {
	 ...
	 * @returns Array of Terminal objects
	 */
	public static getBackgroundTerminals(busy?: boolean): AliTerminal[] {
		return this.getAllTerminals().filter((t) => {
	...
	private static getAllTerminals(): AliTerminal[] {
		this.terminals = this.terminals.filter((t) => !t.isClosed())
		return this.terminals
	}

	private static getTerminalById(id: number): AliTerminal | undefined {
	 ...
	 */
	private static getTerminalByVSCETerminal(vsceTerminal: vscode.Terminal): AliTerminal | undefined {
