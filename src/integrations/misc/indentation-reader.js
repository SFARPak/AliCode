...
exports.computeEffectiveIndents = computeEffectiveIndents
exports.formatWithLineNumbers = formatWithLineNumbers
exports.readWithIndentation = readWithIndentation
exports.readWithSlice = readWithSlice
 ...
 */
function computeEffectiveIndents(lines) {
	const effective = []
 ...
 */
function formatWithLineNumbers(lines, maxLineLength = read_file_1.MAX_LINE_LENGTH) {
 ...
 */
function computeIncludedRanges(lines) {
	if (lines.length === 0) return []
	const ranges = []
 ...
 */
function readWithIndentation(content, options) {
	const {
		anchorLine,
		maxLevels = read_file_1.DEFAULT_MAX_LEVELS,
		includeSiblings = false,
		includeHeader = true,
		limit = read_file_1.DEFAULT_LINE_LIMIT,
		maxLines,
	} = options
 ...
 * @returns The extracted content with metadata
 */
function readWithSlice(content, offset = 0, limit = read_file_1.DEFAULT_LINE_LIMIT) {
	const lines = parseLines(content)
	const totalLines = lines.length
	// Validate offset
