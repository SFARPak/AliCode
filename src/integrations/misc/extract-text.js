...
exports.getSupportedBinaryFormats = getSupportedBinaryFormats
exports.extractTextFromFileWithMetadata = extractTextFromFileWithMetadata
...
exports.applyRunLengthEncoding = applyRunLengthEncoding
exports.processCarriageReturns = processCarriageReturns
exports.processBackspaces = processBackspaces
...
const extract_text_from_xlsx_1 = require("./extract-text-from-xlsx")
const indentation_reader_1 = require("./indentation-reader")
const read_file_1 = require("../../core/prompts/tools/native-tools/read_file")
...
const SUPPORTED_BINARY_FORMATS = {
	...
	".xlsx": extract_text_from_xlsx_1.extractTextFromXLSX,
}
/**
 ...
 */
async function extractTextFromFileWithMetadata(filePath, limit = read_file_1.DEFAULT_LINE_LIMIT) {
	try {
	...
	if (!isBinary) {
		const rawContent = await promises_1.default.readFile(filePath, "utf8")
		const result = (0, indentation_reader_1.readWithSlice)(rawContent, 0, limit)
		return {
 ...
 */
function truncateOutput(content, lineLimit, characterLimit) {
 ...
 */
function applyRunLengthEncoding(content) {
	if (!content) {
		return content
	}
	let result = ""
