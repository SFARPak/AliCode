...
describe("addLineNumbers", () => {
	it("should add line numbers starting from 1 by default", () => {
		...
		expect((0, extract_text_1.addLineNumbers)(input)).toBe(expected)
	})
	it("should add line numbers starting from specified line number", () => {
		const input = "line 1\nline 2\nline 3"
		const expected = "10 | line 1\n11 | line 2\n12 | line 3\n"
		expect((0, extract_text_1.addLineNumbers)(input, 10)).toBe(expected)
	})
	it("should handle empty content", () => {
		expect((0, extract_text_1.addLineNumbers)("")).toBe("")
		expect((0, extract_text_1.addLineNumbers)("", 5)).toBe("5 | \n")
	})
	it("should handle single line content", () => {
		expect((0, extract_text_1.addLineNumbers)("single line")).toBe("1 | single line\n")
		expect((0, extract_text_1.addLineNumbers)("single line", 42)).toBe("42 | single line\n")
	})
	it("should pad line numbers based on the highest line number", () => {
		...
		expect((0, extract_text_1.addLineNumbers)(input, 99)).toBe(expected)
	})
...
describe("everyLineHasLineNumbers", () => {
	it("should return true for content with line numbers", () => {
		...
		expect((0, extract_text_1.everyLineHasLineNumbers)(input)).toBe(true)
	})
	...
	it("should return false for content without line numbers", () => {
		...
		expect((0, extract_text_1.everyLineHasLineNumbers)(input)).toBe(false)
	})
	...
	it("should handle empty content", () => {
		expect((0, extract_text_1.everyLineHasLineNumbers)("")).toBe(false)
	})
...
describe("stripLineNumbers", () => {
	it("should strip line numbers from content", () => {
		...
		expect((0, extract_text_1.stripLineNumbers)(input)).toBe(expected)
	})
	...
	it("should handle content without line numbers", () => {
		const input = "line one\nline two\nline three"
		expect((0, extract_text_1.stripLineNumbers)(input)).toBe(input)
	})
	it("should handle empty content", () => {
		expect((0, extract_text_1.stripLineNumbers)("")).toBe("")
	})
	...
	describe("aggressive mode", () => {
		it("should strip content with just a pipe character", () => {
			const input = "| line one\n| line two\n| line three"
			const expected = "line one\nline two\nline three"
			expect((0, extract_text_1.stripLineNumbers)(input, true)).toBe(expected)
		})
		...
		it("should not strip content with pipe characters not at start in aggressive mode", () => {
			...
			expect((0, extract_text_1.stripLineNumbers)(input, true)).toBe(input)
		})
		it("should handle empty content in aggressive mode", () => {
			expect((0, extract_text_1.stripLineNumbers)("", true)).toBe("")
		})
...
describe("truncateOutput", () => {
	it("returns original content when no line limit provided", () => {
		const content = "line1\nline2\nline3"
		expect((0, extract_text_1.truncateOutput)(content)).toBe(content)
	})
	it("returns original content when lines are under limit", () => {
		const content = "line1\nline2\nline3"
		expect((0, extract_text_1.truncateOutput)(content, 5)).toBe(content)
	})
	it("truncates content with 20/80 split when over limit", () => {
		...
		const result = (0, extract_text_1.truncateOutput)(content, 10)
		// Should keep:
	...
	it("handles empty content", () => {
		expect((0, extract_text_1.truncateOutput)("", 10)).toBe("")
	})
	it("handles single line content", () => {
		expect((0, extract_text_1.truncateOutput)("single line", 10)).toBe("single line")
	})
	describe("processBackspaces", () => {
		it("should handle basic backspace deletion", () => {
			const input = "abc\b\bxy"
			const expected = "axy"
			expect((0, extract_text_1.processBackspaces)(input)).toBe(expected)
		})
	...
	it("handles windows-style line endings", () => {
		...
		const content = lines.join("\r\n")
		const result = (0, extract_text_1.truncateOutput)(content, 5)
	...
	describe("character limit functionality", () => {
		it("returns original content when no character limit provided", () => {
			...
			expect((0, extract_text_1.truncateOutput)(content, undefined, undefined)).toBe(content)
		})
		it("returns original content when characters are under limit", () => {
			const content = "a".repeat(100)
			expect((0, extract_text_1.truncateOutput)(content, undefined, 200)).toBe(content)
		})
		it("truncates content by character limit with 20/80 split", () => {
			// Create content with 1000 characters
			const content = "a".repeat(1000)
			// Set character limit to 100
			const result = (0, extract_text_1.truncateOutput)(content, undefined, 100)
			// Should keep:
		...
		it("prioritizes character limit over line limit", () => {
			...
			const result = (0, extract_text_1.truncateOutput)(content, 10, 100)
		...
		it("falls back to line limit when character limit is satisfied", () => {
			...
			const result = (0, extract_text_1.truncateOutput)(content, 10, 10000)
		...
		it("handles very small character limits", () => {
			const content = "a".repeat(1000)
			const result = (0, extract_text_1.truncateOutput)(content, undefined, 10)
		...
		it("handles character limit with mixed content", () => {
			...
			const result = (0, extract_text_1.truncateOutput)(content, undefined, 50)
		...
		describe("edge cases with very small character limits", () => {
			it("handles character limit of 1", () => {
				...
				const result = (0, extract_text_1.truncateOutput)(content, undefined, 1)
			...
			it("handles character limit of 2", () => {
				const content = "abcdefghijklmnopqrstuvwxyz"
				const result = (0, extract_text_1.truncateOutput)(content, undefined, 2)
			...
			it("handles character limit of 5", () => {
				const content = "abcdefghijklmnopqrstuvwxyz"
				const result = (0, extract_text_1.truncateOutput)(content, undefined, 5)
			...
			it("handles character limit with newlines in content", () => {
				const content = "line1\nline2\nline3\nline4\nline5"
				const result = (0, extract_text_1.truncateOutput)(content, undefined, 15)
			...
			it("handles character limit smaller than omission message", () => {
				const content = "a".repeat(100)
				const result = (0, extract_text_1.truncateOutput)(content, undefined, 3)
			...
			it("prioritizes character limit even with very high line limit", () => {
				const content = "a".repeat(1000)
				const result = (0, extract_text_1.truncateOutput)(content, 999999, 50)
...
describe("applyRunLengthEncoding", () => {
	it("should handle empty input", () => {
		expect((0, extract_text_1.applyRunLengthEncoding)("")).toBe("")
		expect((0, extract_text_1.applyRunLengthEncoding)(null)).toBe(null)
		expect((0, extract_text_1.applyRunLengthEncoding)(undefined)).toBe(undefined)
	})
	it("should compress repeated single lines when beneficial", () => {
		...
		expect((0, extract_text_1.applyRunLengthEncoding)(input)).toBe(expected)
	})
	it("should not compress when not beneficial", () => {
		const input = "y\ny\ny\ny\ny\n"
		expect((0, extract_text_1.applyRunLengthEncoding)(input)).toBe(input)
	})
})
describe("processCarriageReturns", () => {
	it("should return original input if no carriage returns (\r) present", () => {
		const input = "Line 1\nLine 2\nLine 3"
		expect((0, extract_text_1.processCarriageReturns)(input)).toBe(input)
	})
	it("should process basic progress bar with carriage returns (\r)", () => {
		...
		expect((0, extract_text_1.processCarriageReturns)(input)).toBe(expected)
	})
	...
	it("should handle carriage returns (\r) in a way that matches terminal behavior", () => {
		...
		expect((0, extract_text_1.processCarriageReturns)("Line1\r\n")).toBe("Line1\n")
	})
	...
	it("should handle empty input", () => {
		expect((0, extract_text_1.processCarriageReturns)("")).toBe("")
	})
