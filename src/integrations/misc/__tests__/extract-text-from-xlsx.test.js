...
describe("extractTextFromXLSX", () => {
	describe("basic functionality", () => {
		it("should extract text with proper formatting", async () => {
			...
			const result = await (0, extract_text_from_xlsx_1.extractTextFromXLSX)(workbook)
	...
	describe("formatCellValue logic", () => {
		...
		it("should handle hyperlinks", async () => {
			...
			const result = await (0, extract_text_from_xlsx_1.extractTextFromXLSX)(workbook)
			expect(result).toContain("AliCode (https://roocode.com/)")
		})
	...
	describe("function overloads", () => {
		...
		it("should reject invalid file paths", async () => {
			await expect((0, extract_text_from_xlsx_1.extractTextFromXLSX)("/non/existent/file.xlsx")).rejects.toThrow()
		})
	})
})
