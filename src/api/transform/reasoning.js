...
exports.getGeminiReasoning =
	...
	exports.getAliReasoning =
	exports.getOpenRouterReasoning =
		void 0
exports.isGeminiThinkingLevel = isGeminiThinkingLevel
const api_1 = require("../../shared/api")
// Valid Gemini thinking levels for effort-based reasoning
const GEMINI_THINKING_LEVELS = ["minimal", "low", "medium", "high"]
function isGeminiThinkingLevel(value) {
	return typeof value === "string" && GEMINI_THINKING_LEVELS.includes(value)
}
...
const getAliReasoning = ({ model, reasoningEffort, settings }) => {
	...
	// For Ali models that support reasoning effort, absence of a selection should be
	...
	// For Ali, "minimal" is treated as "none" for effort-based reasoning – we omit
...
exports.getAliReasoning = getAliReasoning
...
const getOpenAiReasoning = ({ model, reasoningEffort, settings }) => {
	if (!(0, api_1.shouldUseReasoningEffort)({ model, settings })) return undefined
...
const getGeminiReasoning = ({ model, reasoningBudget, reasoningEffort, settings }) => {
