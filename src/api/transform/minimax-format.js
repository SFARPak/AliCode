...
exports.mergeEnvironmentDetailsForMiniMax = mergeEnvironmentDetailsForMiniMax
exports.extractEnvironmentDetailsForMiniMax = extractEnvironmentDetailsForMiniMax
/**
 ...
 */
function mergeEnvironmentDetailsForMiniMax(messages) {
	const result = []
