...
exports.processResponsesApiStream = processResponsesApiStream
exports.createUsageNormalizer = createUsageNormalizer
/**
 ...
 */
async function* processResponsesApiStream(stream, normalizeUsage) {
 ...
 */
function createUsageNormalizer(calculateCost) {
	return (usage) => {
