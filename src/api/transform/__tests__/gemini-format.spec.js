...
const gemini_format_1 = require("../gemini-format")
describe("convertAnthropicMessageToGemini", () => {
	it("should convert a simple text message", () => {
		...
		const result = (0, gemini_format_1.convertAnthropicMessageToGemini)(anthropicMessage)
	...
	it("should throw an error for unsupported image source type", () => {
		...
		expect(() => (0, gemini_format_1.convertAnthropicMessageToGemini)(anthropicMessage)).toThrow(
	...
	it("should convert a message with tool result as string", () => {
		...
		const result = (0, gemini_format_1.convertAnthropicMessageToGemini)(anthropicMessage, { toolIdToName })
		expect(result).toEqual([
			{
				role: "user",
				parts: [
	...
	it("should throw error when tool_use_id is not in the map", () => {
		...
		expect(() => (0, gemini_format_1.convertAnthropicMessageToGemini)(anthropicMessage, { toolIdToName })).toThrow(
			'Unable to find tool name for tool_use_id "calculator-123"',
		)
	})
