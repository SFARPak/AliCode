...
const image_cleaning_1 = require("../image-cleaning")
describe("maybeRemoveImageBlocks", () => {
	// Mock ApiHandler factory function
	const createMockApiHandler = (supportsImages) => {
		return {
	...
	it("should handle empty messages array", () => {
		...
		const messages = []
		const result = (0, image_cleaning_1.maybeRemoveImageBlocks)(messages, apiHandler)
