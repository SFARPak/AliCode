...
describe("AI SDK conversion utilities", () => {
	describe("convertToAiSdkMessages", () => {
		it("converts simple string messages", () => {
			...
			const result = (0, ai_sdk_1.convertToAiSdkMessages)(messages)
	...
	describe("convertToolsForAiSdk", () => {
		it("returns undefined for empty tools", () => {
			expect((0, ai_sdk_1.convertToolsForAiSdk)(undefined)).toBeUndefined()
			expect((0, ai_sdk_1.convertToolsForAiSdk)([])).toBeUndefined()
		})
		it("converts function tools to AI SDK format", () => {
			...
			const result = (0, ai_sdk_1.convertToolsForAiSdk)(tools)
	...
	describe("processAiSdkStreamPart", () => {
		...
		it("processes error chunks", () => {
			const part = { type: "error", error: new Error("Test error") }
			const chunks = [...(0, ai_sdk_1.processAiSdkStreamPart)(part)]
			expect(chunks).toHaveLength(1)
			expect(chunks[0]).toEqual({
				type: "error",
		...
		it("ignores lifecycle events", () => {
			...
			for (const event of lifecycleEvents) {
				const chunks = [...(0, ai_sdk_1.processAiSdkStreamPart)(event)]
