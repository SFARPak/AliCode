...
describe("MistralHandler", () => {
	...
	beforeEach(() => {
		...
		handler = new mistral_1.MistralHandler(mockOptions)
	...
	describe("constructor", () => {
		it("should initialize with provided options", () => {
			expect(handler).toBeInstanceOf(mistral_1.MistralHandler)
			expect(handler.getModel().id).toBe(mockOptions.apiModelId)
		})
		it("should throw error if API key is missing", () => {
			expect(() => {
				new mistral_1.MistralHandler({
					...mockOptions,
		...
		it("should use custom base URL if provided", () => {
			...
			const handlerWithCustomUrl = new mistral_1.MistralHandler({
				...mockOptions,
				mistralCodestralUrl: customBaseUrl,
			})
			expect(handlerWithCustomUrl).toBeInstanceOf(mistral_1.MistralHandler)
		})
	})
	describe("getModel", () => {
