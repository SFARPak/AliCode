...
const qwen_code_1 = require("../qwen-code")
...
describe("QwenCodeHandler Native Tools", () => {
	...
	beforeEach(() => {
		...
		node_fs_1.promises.readFile.mockResolvedValue(JSON.stringify(mockCredentials))
		node_fs_1.promises.writeFile.mockResolvedValue(undefined)
		mockOptions = {
			apiModelId: "qwen3-coder-plus",
		}
		handler = new qwen_code_1.QwenCodeHandler(mockOptions)
