...
describe("VertexHandler", () => {
	...
	beforeEach(() => {
		...
		handler = new vertex_1.VertexHandler({
	...
	describe("completePrompt", () => {
		...
		it("should handle API errors for Gemini", async () => {
			...
			await expect(handler.completePrompt("Test prompt")).rejects.toThrow(
				(0, i18next_1.t)("common:errors.gemini.generate_complete_prompt", { error: "Vertex API error" }),
			)
		})
	...
	describe("getModel", () => {
		it("should return correct model info for Gemini", () => {
			...
			const testHandler = new vertex_1.VertexHandler({
