...
describe("FireworksHandler", () => {
	...
	beforeEach(() => {
		...
		handler = new fireworks_1.FireworksHandler({ fireworksApiKey: "test-key" })
	})
	afterEach(() => {
		vi.restoreAllMocks()
	})
	it("should use the correct Fireworks base URL", () => {
		new fireworks_1.FireworksHandler({ fireworksApiKey: "test-fireworks-api-key" })
	...
	it("should use the provided API key", () => {
		...
		new fireworks_1.FireworksHandler({ fireworksApiKey })
		expect(openai_1.default).toHaveBeenCalledWith(expect.objectContaining({ apiKey: fireworksApiKey }))
	})
	it("should throw error when API key is not provided", () => {
		expect(() => new fireworks_1.FireworksHandler({})).toThrow("API key is required")
	})
	it("should return default model when no model is specified", () => {
		const model = handler.getModel()
		expect(model.id).toBe(types_1.fireworksDefaultModelId)
		expect(model.info).toEqual(expect.objectContaining(types_1.fireworksModels[types_1.fireworksDefaultModelId]))
	})
	it("should return specified model when valid model is provided", () => {
		const testModelId = "accounts/fireworks/models/qwen3-235b-a22b-instruct-2507"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
		const model = handlerWithModel.getModel()
		expect(model.id).toBe(testModelId)
		expect(model.info).toEqual(expect.objectContaining(types_1.fireworksModels[testModelId]))
	})
	it("should return Kimi K2 Instruct model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/kimi-k2-instruct"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return Kimi K2 Thinking model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/kimi-k2-thinking"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return MiniMax M2 model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/minimax-m2"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return DeepSeek R1 model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/deepseek-r1-0528"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return DeepSeek V3 model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/deepseek-v3"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return DeepSeek V3.1 model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/deepseek-v3p1"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return GLM-4.5 model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/glm-4p5"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return GLM-4.5-Air model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/glm-4p5-air"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return GLM-4.6 model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/glm-4p6"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return gpt-oss-20b model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/gpt-oss-20b"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("should return gpt-oss-120b model with correct configuration", () => {
		const testModelId = "accounts/fireworks/models/gpt-oss-120b"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: testModelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
	...
	it("createMessage should pass correct parameters to Fireworks client", async () => {
		const modelId = "accounts/fireworks/models/kimi-k2-instruct"
		const modelInfo = types_1.fireworksModels[modelId]
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: modelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
		...
		const messages = [{ role: "user", content: "Test message for Fireworks" }]
	...
	it("should use model defaultTemperature (1.0) over provider default (0.5) for kimi-k2-thinking", async () => {
		const modelId = "accounts/fireworks/models/kimi-k2-thinking"
		const handlerWithModel = new fireworks_1.FireworksHandler({
			apiModelId: modelId,
			fireworksApiKey: "test-fireworks-api-key",
		})
