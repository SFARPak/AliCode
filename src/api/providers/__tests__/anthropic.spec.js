...
const mockAnthropicConstructor = vitest.mocked(sdk_1.Anthropic)
describe("AnthropicHandler", () => {
	...
	beforeEach(() => {
		...
		handler = new anthropic_1.AnthropicHandler(mockOptions)
		vitest.clearAllMocks()
	})
	describe("constructor", () => {
		it("should initialize with provided options", () => {
			expect(handler).toBeInstanceOf(anthropic_1.AnthropicHandler)
		...
		it("should initialize with undefined API key", () => {
			...
			const handlerWithoutKey = new anthropic_1.AnthropicHandler({
				...mockOptions,
				apiKey: undefined,
			})
			expect(handlerWithoutKey).toBeInstanceOf(anthropic_1.AnthropicHandler)
		})
		it("should use custom base URL if provided", () => {
			const customBaseUrl = "https://custom.anthropic.com"
			const handlerWithCustomUrl = new anthropic_1.AnthropicHandler({
				...mockOptions,
				anthropicBaseUrl: customBaseUrl,
			})
			expect(handlerWithCustomUrl).toBeInstanceOf(anthropic_1.AnthropicHandler)
		})
	...
	describe("createMessage", () => {
		...
		it("should include 1M context beta header for Claude Sonnet 4.6 when enabled", async () => {
			const sonnet46Handler = new anthropic_1.AnthropicHandler({
				apiKey: "test-api-key",
	...
	describe("getModel", () => {
		it("should return default model if no model ID is provided", () => {
			const handlerWithoutModel = new anthropic_1.AnthropicHandler({
				...mockOptions,
		...
		it("honors custom maxTokens for thinking models", () => {
			const handler = new anthropic_1.AnthropicHandler({
				apiKey: "test-api-key",
	...
	describe("reasoning block filtering", () => {
		...
		it("should filter out internal reasoning blocks before sending to API", async () => {
			handler = new anthropic_1.AnthropicHandler({
				apiKey: "test-api-key",
				apiModelId: "claude-3-5-sonnet-20241022",
			})
		...
		it("should filter empty messages after removing all reasoning blocks", async () => {
			...
			const messagesWithOnlyReasoning = [
				{
					role: "user",
					content: "Hello",
				},
			...
			expect(calledMessages.every((m) => m.role === "user")).toBe(true)
		})
	})
	describe("native tool calling", () => {
		...
		it("should include tools when tools are provided", async () => {
			const xmlHandler = new anthropic_1.AnthropicHandler({
				...mockOptions,
			})
