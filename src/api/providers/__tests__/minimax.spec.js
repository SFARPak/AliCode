...
describe("MiniMaxHandler", () => {
	...
	beforeEach(() => {
		...
		const anthropicInstance = sdk_1.Anthropic()
		mockCreate = anthropicInstance.messages.create
	})
	describe("International MiniMax (default)", () => {
		beforeEach(() => {
			handler = new minimax_1.MiniMaxHandler({
				minimaxApiKey: "test-minimax-api-key",
				minimaxBaseUrl: "https://api.minimax.io/v1",
			})
		})
		it("should use the correct international MiniMax base URL by default", () => {
			new minimax_1.MiniMaxHandler({ minimaxApiKey: "test-minimax-api-key" })
			expect(sdk_1.Anthropic).toHaveBeenCalledWith(
		...
		it("should use the provided API key", () => {
			...
			new minimax_1.MiniMaxHandler({ minimaxApiKey })
			expect(sdk_1.Anthropic).toHaveBeenCalledWith(expect.objectContaining({ apiKey: minimaxApiKey }))
		})
		it("should return default model when no model is specified", () => {
			const model = handler.getModel()
			expect(model.id).toBe(types_1.minimaxDefaultModelId)
			expect(model.info).toEqual(types_1.minimaxModels[types_1.minimaxDefaultModelId])
		})
		it("should return specified model when valid model is provided", () => {
			const testModelId = "MiniMax-M2"
			const handlerWithModel = new minimax_1.MiniMaxHandler({
				apiModelId: testModelId,
				minimaxApiKey: "test-minimax-api-key",
			})
			const model = handlerWithModel.getModel()
			expect(model.id).toBe(testModelId)
			expect(model.info).toEqual(types_1.minimaxModels[testModelId])
		})
		it("should return MiniMax-M2.5 model with correct configuration", () => {
			const testModelId = "MiniMax-M2.5"
			const handlerWithModel = new minimax_1.MiniMaxHandler({
				apiModelId: testModelId,
				minimaxApiKey: "test-minimax-api-key",
			})
		...
		it("should return MiniMax-M2-Stable model with correct configuration", () => {
			const testModelId = "MiniMax-M2-Stable"
			const handlerWithModel = new minimax_1.MiniMaxHandler({
				apiModelId: testModelId,
				minimaxApiKey: "test-minimax-api-key",
			})
	...
	describe("China MiniMax", () => {
		...
		it("should use the provided API key for China", () => {
			const minimaxApiKey = "test-minimax-api-key"
			new minimax_1.MiniMaxHandler({ minimaxApiKey, minimaxBaseUrl: "https://api.minimaxi.com/v1" })
			expect(sdk_1.Anthropic).toHaveBeenCalledWith(expect.objectContaining({ apiKey: minimaxApiKey }))
		})
		it("should return default model when no model is specified", () => {
			const model = handler.getModel()
	...
	describe("Default behavior", () => {
		it("should default to international base URL when none is specified", () => {
			const handlerDefault = new minimax_1.MiniMaxHandler({ minimaxApiKey: "test-minimax-api-key" })
			expect(sdk_1.Anthropic).toHaveBeenCalledWith(
				expect.objectContaining({
					baseURL: "https://api.minimax.io/anthropic",
				}),
	...
	describe("API Methods", () => {
		beforeEach(() => {
			handler = new minimax_1.MiniMaxHandler({ minimaxApiKey: "test-minimax-api-key" })
		})
		...
		it("createMessage should pass correct parameters to MiniMax client", async () => {
			const modelId = "MiniMax-M2"
			const modelInfo = types_1.minimaxModels[modelId]
			const handlerWithModel = new minimax_1.MiniMaxHandler({
				apiModelId: modelId,
				minimaxApiKey: "test-minimax-api-key",
			})
			...
			const messages = [{ role: "user", content: "Test message for MiniMax" }]
	...
	describe("Model Configuration", () => {
		it("should correctly configure MiniMax-M2 model properties", () => {
			const model = types_1.minimaxModels["MiniMax-M2"]
		...
		it("should correctly configure MiniMax-M2-Stable model properties", () => {
			const model = types_1.minimaxModels["MiniMax-M2-Stable"]
			expect(model.maxTokens).toBe(16_384)
			expect(model.contextWindow).toBe(204_800)
			expect(model.supportsImages).toBe(false)
			expect(model.supportsPromptCache).toBe(true)
		...
		it("should correctly configure MiniMax-M2.7 model properties", () => {
			const model = types_1.minimaxModels["MiniMax-M2.7"]
			expect(model.maxTokens).toBe(16_384)
			expect(model.contextWindow).toBe(204_800)
			expect(model.supportsImages).toBe(false)
			expect(model.supportsPromptCache).toBe(true)
		...
		it("should correctly configure MiniMax-M2.7-highspeed model properties", () => {
			const model = types_1.minimaxModels["MiniMax-M2.7-highspeed"]
			expect(model.maxTokens).toBe(16_384)
			expect(model.contextWindow).toBe(204_800)
			expect(model.supportsImages).toBe(false)
			expect(model.supportsPromptCache).toBe(true)
		...
		it("should correctly configure MiniMax-M2.5-highspeed model properties", () => {
			const model = types_1.minimaxModels["MiniMax-M2.5-highspeed"]
			expect(model.maxTokens).toBe(16_384)
			expect(model.contextWindow).toBe(204_800)
			expect(model.supportsImages).toBe(false)
			expect(model.supportsPromptCache).toBe(true)
		...
		it("should correctly configure MiniMax-M2.1-highspeed model properties", () => {
			const model = types_1.minimaxModels["MiniMax-M2.1-highspeed"]
			expect(model.maxTokens).toBe(16_384)
			expect(model.contextWindow).toBe(204_800)
			expect(model.supportsImages).toBe(false)
			expect(model.supportsPromptCache).toBe(true)
		...
		it("should correctly configure MiniMax-M2.1 model properties with updated context window", () => {
			const model = types_1.minimaxModels["MiniMax-M2.1"]
			expect(model.contextWindow).toBe(204_800)
		})
