...
describe("RequestyHandler", () => {
	...
	it("initializes with correct options", () => {
		const handler = new requesty_1.RequestyHandler(mockOptions)
		expect(handler).toBeInstanceOf(requesty_1.RequestyHandler)
	...
	it("can use a base URL instead of the default", () => {
		const handler = new requesty_1.RequestyHandler({
			...mockOptions,
