...
const anthropic_vertex_1 = require("../anthropic-vertex")
...
describe("VertexHandler", () => {
	...
	describe("constructor", () => {
		it("should initialize with provided config for Claude", () => {
			handler = new anthropic_vertex_1.AnthropicVertexHandler({
				apiModelId: "claude-3-5-sonnet-v2@20241022",
				vertexProjectId: "test-project",
				vertexRegion: "us-central1",
			})
			expect(vertex_sdk_1.AnthropicVertex).toHaveBeenCalledWith({
	...
	describe("getModel", () => {
		...
		it("honors custom maxTokens for thinking models", () => {
			const handler = new anthropic_vertex_1.AnthropicVertexHandler({
				apiKey: "test-api-key",
		...
		it("should enable 1M context for Claude Sonnet 4 when beta flag is set", () => {
			const handler = new anthropic_vertex_1.AnthropicVertexHandler({
				apiModelId: types_1.VERTEX_1M_CONTEXT_MODEL_IDS[0],
				vertexProjectId: "test-project",
				vertexRegion: "us-central1",
		...
		it("should enable 1M context for Claude Sonnet 4.5 when beta flag is set", () => {
			const handler = new anthropic_vertex_1.AnthropicVertexHandler({
				apiModelId: types_1.VERTEX_1M_CONTEXT_MODEL_IDS[1],
				vertexProjectId: "test-project",
				vertexRegion: "us-central1",
				vertex1MContext: true,
			})
	...
	describe("thinking model configuration", () => {
		it("should configure thinking for models with :thinking suffix", () => {
			const thinkingHandler = new anthropic_vertex_1.AnthropicVertexHandler({
				apiModelId: "claude-3-7-sonnet@20250219:thinking",
				vertexProjectId: "test-project",
				vertexRegion: "us-central1",
		...
		it("should calculate thinking budget correctly", () => {
			...
			const handlerWithBudget = new anthropic_vertex_1.AnthropicVertexHandler({
				apiModelId: "claude-3-7-sonnet@20250219:thinking",
				vertexProjectId: "test-project",
				vertexRegion: "us-central1",
				modelMaxTokens: 16384,
			...
			const handlerWithDefaultBudget = new anthropic_vertex_1.AnthropicVertexHandler({
				apiModelId: "claude-3-7-sonnet@20250219:thinking",
				vertexProjectId: "test-project",
				vertexRegion: "us-central1",
			...
			const handlerWithSmallMaxTokens = new anthropic_vertex_1.AnthropicVertexHandler({
				apiModelId: "claude-3-7-sonnet@20250219:thinking",
				vertexProjectId: "test-project",
				vertexRegion: "us-central1",
		...
		it("should pass thinking configuration to API", async () => {
			...
			thinkingHandler["client"].messages.create = mockCreate
