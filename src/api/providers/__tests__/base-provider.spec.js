...
class TestProvider extends base_provider_1.BaseProvider {
	createMessage(_systemPrompt, _messages) {
	...
	testConvertToolSchemaForOpenAI(schema) {
		return this.convertToolSchemaForOpenAI(schema)
	}
	// Expose protected method for testing
	testConvertToolsForOpenAI(tools) {
