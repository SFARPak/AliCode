...
const MockedLMStudioClientConstructor = sdk_1.LMStudioClient
describe("LMStudio Fetcher", () => {
	...
	describe("parseLMStudioModel", () => {
		it("should correctly parse raw LLMInfo to ModelInfo", () => {
			...
			const expectedModelInfo = {
				...types_1.lMStudioDefaultModelInfo,
			...
			const result = (0, lmstudio_1.parseLMStudioModel)(rawModel)
	...
	describe("getLMStudioModels", () => {
		...
		it("should fetch downloaded models using system.listDownloadedModels", async () => {
			...
			const result = await (0, lmstudio_1.getLMStudioModels)(baseUrl)
			...
			const expectedParsedModel = (0, lmstudio_1.parseLMStudioModel)(mockLLMInfo)
		...
		it("should fall back to listLoaded when listDownloadedModels fails", async () => {
			...
			const expectedParsedModel = (0, lmstudio_1.parseLMStudioModel)(mockRawModel)
		...
		it("should deduplicate models when both downloaded and loaded", async () => {
			...
			const expectedParsedModel = (0, lmstudio_1.parseLMStudioModel)(mockLoadedModel)
		...
		it("should use default baseUrl if an empty string is provided", async () => {
			...
			mockListLoaded.mockResolvedValueOnce([])
			await (0, lmstudio_1.getLMStudioModels)("")
		...
		it("should transform https baseUrl to wss for LMStudioClient", async () => {
			...
			mockedAxios.get.mockResolvedValueOnce({ data: {} })
			mockListLoaded.mockResolvedValueOnce([])
			await (0, lmstudio_1.getLMStudioModels)(httpsBaseUrl)
		...
		it("should return an empty object if lmsUrl is unparsable", async () => {
			...
			const result = await (0, lmstudio_1.getLMStudioModels)(unparsableBaseUrl)
