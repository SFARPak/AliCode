...
import { getGlobalAliDirectory, getProjectAliDirectoryForCwd } from "../ali-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join(getGlobalAliDirectory(), "commands")
	...
	const projectDir = path.join(getProjectAliDirectoryForCwd(cwd), "commands")
