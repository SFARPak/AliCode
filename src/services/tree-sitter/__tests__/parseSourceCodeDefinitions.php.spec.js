...
describe("parseSourceCodeDefinitionsForFile with PHP", () => {
	...
	it("should inspect PHP tree structure", async () => {
		await (0, helpers_1.inspectTreeStructure)(sample_php_1.default, "php")
	})
	it("should parse PHP definitions", async () => {
		await (0, helpers_1.testParseSourceCodeDefinitions)("test.php", sample_php_1.default, phpOptions)
	})
})
