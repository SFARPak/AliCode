...
describe("CodeParser - VB.NET and Fallback Extensions Support", () => {
	...
	it("should use fallback chunking for VB.NET files", async () => {
		...
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".vb")).toBe(true)
		const vbContent = `
Imports System
...
describe("Fallback Extensions Configuration", () => {
	it("should correctly identify extensions that need fallback chunking", () => {
		...
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".vb")).toBe(true)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".scala")).toBe(true)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".swift")).toBe(true)
		// Extensions that should not use fallback (have working parsers)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".js")).toBe(false)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".ts")).toBe(false)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".py")).toBe(false)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".java")).toBe(false)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".cs")).toBe(false)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".go")).toBe(false)
		expect((0, supported_extensions_1.shouldUseFallbackChunking)(".rs")).toBe(false)
	})
