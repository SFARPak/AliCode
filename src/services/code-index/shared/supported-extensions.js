...
exports.fallbackExtensions = exports.scannerExtensions = void 0
exports.shouldUseFallbackChunking = shouldUseFallbackChunking
const tree_sitter_1 = require("../../tree-sitter")
// Include all extensions including markdown for the scanner
exports.scannerExtensions = tree_sitter_1.extensions
/**
 ...
 */
function shouldUseFallbackChunking(extension) {
	return exports.fallbackExtensions.includes(extension.toLowerCase())
}
