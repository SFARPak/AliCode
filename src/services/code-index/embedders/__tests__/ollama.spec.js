...
describe("CodeIndexOllamaEmbedder", () => {
	...
	beforeEach(() => {
		...
		embedder = new ollama_1.CodeIndexOllamaEmbedder({
	...
	describe("constructor", () => {
		...
		it("should use default values when not provided", () => {
			const embedderWithDefaults = new ollama_1.CodeIndexOllamaEmbedder({})
		...
		it("should normalize URLs with trailing slashes", async () => {
			...
			const embedderWithTrailingSlash = new ollama_1.CodeIndexOllamaEmbedder({
				ollamaBaseUrl: "http://localhost:11434/",
				ollamaModelId: "nomic-embed-text",
			})
		...
		it("should not modify URLs without trailing slashes", async () => {
			...
			const embedderWithoutTrailingSlash = new ollama_1.CodeIndexOllamaEmbedder({
				ollamaBaseUrl: "http://localhost:11434",
				ollamaModelId: "nomic-embed-text",
			})
		...
		it("should handle multiple trailing slashes", async () => {
			...
			const embedderWithMultipleTrailingSlashes = new ollama_1.CodeIndexOllamaEmbedder({
				ollamaBaseUrl: "http://localhost:11434///",
				ollamaModelId: "nomic-embed-text",
			})
			// Mock successful /api/tags call
