...
const MockedOpenAiEmbedder = openai_1.OpenAiEmbedder
const MockedCodeIndexOllamaEmbedder = ollama_1.CodeIndexOllamaEmbedder
const MockedOpenAICompatibleEmbedder = openai_compatible_1.OpenAICompatibleEmbedder
const MockedGeminiEmbedder = gemini_1.GeminiEmbedder
const MockedQdrantVectorStore = qdrant_client_1.QdrantVectorStore
// Import the mocked functions
const embeddingModels_1 = require("../../../shared/embeddingModels")
const mockGetDefaultModelId = embeddingModels_1.getDefaultModelId
const mockGetModelDimension = embeddingModels_1.getModelDimension
describe("CodeIndexServiceFactory", () => {
	...
	beforeEach(() => {
		...
		mockCacheManager = {}
		factory = new service_factory_1.CodeIndexServiceFactory(mockConfigManager, "/test/workspace", mockCacheManager)
	})
