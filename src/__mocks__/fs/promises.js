...
const mockFs = {
	readFile: vitest_1.vi.fn().mockImplementation(async (filePath, _encoding) => {
	...
	writeFile: vitest_1.vi.fn().mockImplementation(async (path, content) => {
	...
	mkdir: vitest_1.vi.fn().mockImplementation(async (path, options) => {
	...
	access: vitest_1.vi.fn().mockImplementation(async (path) => {
	...
	rename: vitest_1.vi.fn().mockImplementation(async (oldPath, newPath) => {
