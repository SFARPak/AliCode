					...
					{(reply) => (
						<div class="kiloclaw-msg-reply">
							...
							<Show
								when={!reply().deleted}
								fallback={
									<span class="kiloclaw-msg-reply-deleted">{t("kiloClaw.message.replyDeleted")}</span>
								}>
							...
							<Show when={!isEditing() && !isDeleting()}>
								<div class="kiloclaw-msg-body">
									<Show
										when={!empty()}
										fallback={
											<span class="kiloclaw-msg-thinking">{t("kiloClaw.message.thinking")}</span>
										}>
										<Show
											when={isBot()}
											fallback={<span class="kiloclaw-msg-text">{textContent()}</span>}>
										...
										<Show
											...
											fallback={
												<div class="kiloclaw-msg-actions-resolved">
													...
													<span>
														{block.actions.find((a) => a.value === block.resolved!.value)
															?.label ?? block.resolved!.value}
													</span>
												</div>
											}>
