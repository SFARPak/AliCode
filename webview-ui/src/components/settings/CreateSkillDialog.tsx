...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@ali-code/types"
...
/**
 * Validate skill name using shared validation from @ali-code/types.
