...
import type { SkillMetadata } from "@ali-code/types"
...
const mockSkills: SkillMetadata[] = [
	{
		...
		path: "/workspace/.ali/skills/project-skill/SKILL.md",
		source: "project",
	},
	{
		name: "project-mode-skill",
		description: "A project mode-specific skill",
		path: "/workspace/.ali/skills/project-mode-skill/SKILL.md",
		source: "project",
		modeSlugs: ["architect"],
	},
	{
		...
		path: "/home/.ali/skills/global-skill/SKILL.md",
		source: "global",
	},
]
