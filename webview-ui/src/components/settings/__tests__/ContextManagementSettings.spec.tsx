...
describe("ContextManagementSettings", () => {
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.aliignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.aliignore.description")).toBeInTheDocument()
		})
