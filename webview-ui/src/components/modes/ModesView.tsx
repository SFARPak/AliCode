...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@ali-code/types"
...
import { TOOL_GROUPS } from "@ali/tools"
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.ali/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},
