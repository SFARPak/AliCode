 ...
 */
export const dynamicProviders = ["openrouter", "vercel-ai-gateway", "litellm", "requesty", "unbound", "poe"]
export const isDynamicProvider = (key) => dynamicProviders.includes(key)
/**
 * LocalProvider
 *
 * Local providers require localhost API calls in order to get the model list.
 */
export const localProviders = ["ollama", "lmstudio"]
export const isLocalProvider = (key) => localProviders.includes(key)
/**
 * InternalProvider
 *
 ...
 * model list.
 */
export const internalProviders = ["vscode-lm"]
export const isInternalProvider = (key) => internalProviders.includes(key)
/**
 * CustomProvider
 *
 * Custom providers are completely configurable within Ali Code settings.
 */
export const customProviders = ["openai"]
export const isCustomProvider = (key) => customProviders.includes(key)
/**
 * FauxProvider
 *
 ...
 * model lists.
 */
export const fauxProviders = ["fake-ai"]
export const isFauxProvider = (key) => fauxProviders.includes(key)
/**
 * ProviderName
 */
...
export const isProviderName = (key) => typeof key === "string" && providerNames.includes(key)
/**
 * RetiredProviderName
 */
...
export const isRetiredProvider = (value) => retiredProviderNames.includes(value)
...
export const getModelId = (settings) => {
	const modelIdKey = modelIdKeys.find((key) => settings[key])
	return modelIdKey ? settings[modelIdKey] : undefined
}
export const isTypicalProvider = (key) =>
...
export const ANTHROPIC_STYLE_PROVIDERS = ["anthropic", "bedrock", "minimax"]
export const getApiProtocol = (provider, modelId) => {
