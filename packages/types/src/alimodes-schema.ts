/**
 * Builds the Zod schema for .alimodes configuration files and converts it
...
// Build the top-level .alimodes schema.
...
/**
 * Generates the JSON Schema object for .alimodes configuration files.
 * Includes metadata fields ($id, title, description).
 */
export function generateAlimodesJsonSchema(): Record<string, unknown> {
