 ...
 */
export const reasoningEffortsExtended = ["none", "minimal", "low", "medium", "high", "xhigh"]
export const reasoningEffortExtendedSchema = z.enum(reasoningEffortsExtended)
/**
 * Reasoning Effort user setting (includes "disable")
 */
export const reasoningEffortSettingValues = ["disable", "none", "minimal", "low", "medium", "high", "xhigh"]
