import { z } from "zod"
import { PROVIDER_SETTINGS_KEYS, providerSettingsEntrySchema, providerSettingsSchema } from "./provider-settings.js"
 ...
 */
export const TERMINAL_PREVIEW_BYTES = {
	small: 5 * 1024, // 5KB
	medium: 10 * 1024, // 10KB
	large: 20 * 1024, // 20KB
}
 ...
 */
export const DEFAULT_TERMINAL_OUTPUT_PREVIEW_SIZE = "medium"
/**
...
export const isSecretStateKey = (key) => SECRET_STATE_KEYS.includes(key) || GLOBAL_SECRET_KEYS.includes(key)
export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key) => !isSecretStateKey(key),
)
export const isGlobalStateKey = (key) => GLOBAL_STATE_KEYS.includes(key)
