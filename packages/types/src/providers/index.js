...
import { nvidiaNimDefaultModelId } from "./nvidia-nim.js"
/**
 ...
 */
export function getProviderDefaultModelId(provider, options = { isChina: false }) {
	switch (provider) {
		case "openrouter":
		...
		case "nvidia-nim":
			return nvidiaNimDefaultModelId
		case "zai":
