...
export declare const fireworksModels: {
	...
	readonly "accounts/fireworks/models/minimax-m2p1": {
		...
		readonly inputPrice: 0.3
		readonly outputPrice: 1.2
		readonly description: "MiniMax M2.1 is an upgraded version of M2 with improved performance on complex reasoning, coding, and long-context understanding tasks."
	}
	readonly "accounts/fireworks/models/deepseek-v3p2": {
		...
		readonly inputPrice: 0.56
		readonly outputPrice: 1.68
		readonly description: "DeepSeek V3.2 is the latest iteration of the V3 model family with enhanced reasoning capabilities, improved code generation, and better instruction following."
	}
	readonly "accounts/fireworks/models/glm-4p7": {
		...
		readonly inputPrice: 0.55
		readonly outputPrice: 2.19
		readonly description: "Z.ai GLM-4.7 is the latest coding model with exceptional performance on complex programming tasks. Features improved reasoning capabilities and enhanced code generation quality."
	}
	readonly "accounts/fireworks/models/llama-v3p3-70b-instruct": {
		readonly maxTokens: 16384
		...
		readonly inputPrice: 0.9
		readonly outputPrice: 0.9
		readonly description: "Meta Llama 3.3 70B Instruct is a highly capable instruction-tuned model with strong reasoning, coding, and general task performance."
	}
	readonly "accounts/fireworks/models/llama4-maverick-instruct-basic": {
		readonly maxTokens: 16384
		readonly contextWindow: 131072
		readonly supportsImages: true
		readonly supportsPromptCache: false
		readonly inputPrice: 0.22
		readonly outputPrice: 0.88
		readonly description: "Llama 4 Maverick is Meta's latest multimodal model with vision capabilities, optimized for instruction following and coding tasks."
	}
	readonly "accounts/fireworks/models/llama4-scout-instruct-basic": {
		readonly maxTokens: 16384
		readonly contextWindow: 131072
		readonly supportsImages: true
		readonly supportsPromptCache: false
		readonly inputPrice: 0.15
		readonly outputPrice: 0.6
		readonly description: "Llama 4 Scout is a smaller, faster variant of Llama 4 with multimodal capabilities, ideal for quick iterations and cost-effective deployments."
	}
}
