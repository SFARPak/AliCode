...
This package provides IPC functionality for Ali Code, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: AliCode settings object
...
```typescript
import { IpcClient } from "@ali-code/ipc"
