 ...
 */
export function consolidateTokenUsage(messages) {
	const result = {
		totalTokensIn: 0,
		totalTokensOut: 0,
 ...
 */
export function hasTokenUsageChanged(current, snapshot) {
	if (!snapshot) {
		return true
	}
	const keysToCompare = [
 ...
 */
export function hasToolUsageChanged(current, snapshot) {
