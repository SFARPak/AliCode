 ...
 */
export const NODE_BUILTIN_MODULES = [...builtinModules, ...builtinModules.map((m) => `node:${m}`)]
/**
 ...
 */
function findEsbuildWasmScript(startDir) {
	const maxDepth = 10
 ...
 */
export function getEsbuildScriptPath(extensionPath) {
 ...
 */
export async function runEsbuild(options, extensionPath) {
