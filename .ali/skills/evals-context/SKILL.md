---
name: evals-context
description: Provides context about the Ali Code evals system structure in this monorepo. Use when tasks mention "evals", "evaluation", "eval runs", "eval exercises", or working with the evals infrastructure. Helps distinguish between the evals execution system (packages/evals, apps/web-evals) and the public website evals display page (apps/web-ali-code/src/app/evals).
---
...
- Modifying the public evals display page on alicode.com
...
| **Website Evals Page**      | `apps/web-ali-code/src/app/evals/`                             | Public alicode.com page displaying eval results                |
| **External Exercises Repo** | [Ali-Code-Evals](https://github.com/AliCodeInc/Ali-Code-Evals) | Actual coding exercises (NOT in this monorepo)                 |
...
### `apps/web-ali-code/src/app/evals/` - Public Website Evals Page

```
apps/web-ali-code/src/app/evals/
...
This page **displays** eval results on the public alicode.com website. It imports types from `@ali-code/evals` but does NOT run evals.
...
- **Runner**: Isolated Docker container with VS Code + Ali Code extension + language runtimes
...
1. Add exercise to [Ali-Code-Evals](https://github.com/AliCodeInc/Ali-Code-Evals) repo (external)
...
Edit files in [`apps/web-ali-code/src/app/evals/`](apps/web-ali-code/src/app/evals/):

- [`evals.tsx`](apps/web-ali-code/src/app/evals/evals.tsx) - Display component
- [`plot.tsx`](apps/web-ali-code/src/app/evals/plot.tsx) - Charts
...
## Key Types/Exports from `@ali-code/evals`
...
- Used by both `apps/web-evals` and `apps/web-ali-code`
